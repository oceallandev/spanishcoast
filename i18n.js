...
(() => {
  ...
  // Bump when i18n auto/dynamic translation behaviour changes so old cached outputs can't cause UI loops.
  const AUTO_CACHE_VERSION = '20260215c';
  ...
  const DYNAMIC_CACHE_VERSION = '20260215c';
  ...
  const DICT = {
    en: {
      ...
      'common.copy': 'Copy',
      'common.open': 'Open',
      'common.back_to_account': 'Back to Account',
      ...
      'network.hero.title': 'Network',
      'network.hero.subtitle': 'Agencies, agents, developers, developments, and verified collaborators across Costa Blanca South.',
      'network.cta.join': 'Apply to join',
      'network.cta.services': 'See services',
      'network.cta.whatsapp': 'WhatsApp',
      'network.cta.website': 'Website',
      'network.filters.search': 'Search',
      'network.filters.search_placeholder': 'Search profiles…',
      'network.filters.type': 'Type',
      'network.kind.agencies': 'Agencies',
      'network.kind.agents': 'Agents',
      'network.kind.developers': 'Developers',
      'network.kind.developments': 'Developments',
      'network.kind.collaborators': 'Collaborators',
      'network.kind.agency': 'Agency',
      'network.kind.agent': 'Agent',
      'network.kind.developer': 'Developer',
      'network.kind.development': 'Development',
      'network.kind.collaborator': 'Collaborator',
      'network.verified': 'Verified',
      'network.suspended': 'Suspended',
      'network.suspended_reason_unknown': 'No reason provided.',
      'network.count': '{n} profiles',
      'network.empty.title': 'No profiles yet',
      'network.empty.subtitle': 'Add profiles in network-data.js.',
      'network.card.open_hint': 'Tap card to open profile',
      'network.card.open_aria': 'Open profile: {name}',
      'network.profile.back': '← Back to Network',
      'network.profile.unknown': 'Profile',
      'network.profile.loading': 'Loading…',
      'network.profile.loading_subtitle': 'Preparing profile…',
      'network.profile.suspended_title': 'Profile unavailable',
      'network.profile.suspended_subtitle': 'This profile is currently unavailable.',
      'network.profile.not_found_title': 'Profile not found',
      'network.profile.not_found_subtitle': 'Go back to the Network directory to pick a profile.',
      'network.profile.contact': 'Contact',
      'network.profile.quick_facts': 'Quick facts',
      'network.profile.location': 'Location',
      'network.profile.languages': 'Languages',
      'network.profile.ref': 'Reference',
      'network.profile.source_ref': 'Source ref',
      'network.profile.source_ref_btn': 'Show',
      'network.profile.source_ref_loading': 'Loading…',
      'network.profile.source_ref_copy': 'Copy',
      'network.profile.source_ref_copied': 'Copied',
      'network.profile.source_ref_not_found': 'Not found',
      'network.profile.source_ref_table_missing': 'Missing table',
      'network.profile.source_ref_admin_only': 'Admin only',
      'network.profile.source_ref_failed': 'Failed',
      'network.profile.source_refs': 'Source refs',
      'network.profile.about': 'About',
      'network.profile.no_bio': 'No bio yet.',
      'network.profile.relationships': 'Relationships',
      'network.profile.agent_of_agency': 'Agency',
      'network.profile.agent_of_developer': 'Developer',
      'network.profile.development_developer': 'Developer',
      'network.profile.agency_agents': 'Agents in this agency',
      'network.profile.developer_developments': 'Developments',
      'network.profile.developer_agents': 'Developer agents',
      'network.profile.no_relationships': 'No relationships defined yet.',
      'network.profile.claim.title': 'Own this profile?',
      'network.profile.claim.subtitle': 'If you represent this profile, you can request to edit or delete it.',
      'network.profile.claim.open_btn': 'Request control',
      'network.profile.claim.email_btn': 'Email us',
      'network.profile.claim.action': 'Action',
      'network.profile.claim.action_edit': 'Edit this profile',
      'network.profile.claim.action_delete': 'Delete this profile',
      'network.profile.claim.name': 'Your name',
      'network.profile.claim.name_placeholder': 'Your full name',
      'network.profile.claim.email': 'Your email',
      'network.profile.claim.email_placeholder': 'you@company.com',
      'network.profile.claim.message': 'Message',
      'network.profile.claim.message_placeholder': 'Add proof (website, phone, role) and what you want to change…',
      'network.profile.claim.submit': 'Send request',
      'network.profile.claim.sending': 'Sending…',
      'network.profile.claim.sent': 'Request sent. Our team will reply by email.',
      'network.profile.claim.invalid_email': 'Please enter a valid email.',
      'network.profile.claim.sign_in_required': 'Sign in first on Account, then submit again.',
      'network.profile.claim.no_client': 'Supabase client not available on this page.',
      'network.profile.claim.table_missing': 'Claim requests table is missing. Admin: run `supabase_network_claims.sql` in Supabase SQL editor.',
      'network.profile.claim.failed': 'Failed to send: {error}',
      'network.footer.p': 'Local network for Costa Blanca South: agencies, agents, developers, and verified collaborators.',

      'netrefmap.title': 'Network Source Reference Map',
      'netrefmap.subtitle': 'Admin-only tool to populate Supabase <code>public.network_profile_ref_map</code>. This powers the <b>Source ref</b> button on Network profile pages, so admins can copy the original developer/development references (e.g. REDSP <code>P01939</code> or office id).',
      'netrefmap.upload_title': 'Upload a CSV',
      'netrefmap.upload_help': 'CSV columns: <code>scp_ref</code>, <code>kind</code>, <code>source</code>, <code>original_ref</code>, <code>original_id</code>. Header row is optional.',
      'netrefmap.csv_file': 'CSV file',
      'netrefmap.csv_paste': 'Or paste CSV',
      'netrefmap.parse': 'Parse',
      'netrefmap.import': 'Import to Supabase',
      'netrefmap.importing': 'Importing…',
      'netrefmap.parsed': 'Parsed:',
      'netrefmap.preview_title': 'Preview',
      'netrefmap.preview_help': 'Shows the first 20 rows that will be imported.',
      'netrefmap.col.scp_ref': 'SCP ref',
      'netrefmap.col.kind': 'Kind',
      'netrefmap.col.source': 'Source',
      'netrefmap.col.original_ref': 'Original ref',
      'netrefmap.col.original_id': 'Original ID',
      'netrefmap.lookup_title': 'Lookup',
      'netrefmap.lookup_help': 'Quick check to verify that a ref was imported and is readable through RLS.',
      'netrefmap.lookup': 'Lookup',
      'netrefmap.lookup.loading': 'Loading…',
      'netrefmap.lookup.not_found': 'Not found. (Did you import it yet?)',
      'netrefmap.lookup.failed': 'Lookup failed: {error}',
      'netrefmap.warn.empty': 'No CSV rows found.',
      'netrefmap.warn.header': 'Header detected but required columns were not found. Expected scp_ref + kind + original_ref.',
      'netrefmap.warn.scp_format': 'Skipping row with invalid SCP ref: {ref}',
      'netrefmap.warn.kind_format': 'Skipping row with invalid kind: {kind}',
      'netrefmap.auth.signed_out': 'Signed out. Sign in on the Account page first.',
      'netrefmap.auth.admin': 'Signed in as {email} (admin).',
      'netrefmap.auth.not_admin': 'Signed in as {email}. Admin role required for import.',
      'netrefmap.auth.no_supabase': 'Supabase not configured (config.js missing?).',
      'netrefmap.auth.checking': 'Checking session…',
      'netrefmap.auth.failed': 'Failed to check session.',
      'netrefmap.error.read_failed': 'Failed to read file.',
      'netrefmap.error.not_admin': 'Admin role required.',
      'netrefmap.error.no_supabase': 'Supabase is not configured on this site.',
      'netrefmap.error.import_failed': 'Import failed: {error}',
      'netrefmap.status.ready': 'Ready. Upload or paste a CSV, then Parse.',
      'netrefmap.status.parsed': 'Parsed {count} rows. Ready to import.',
      'netrefmap.status.importing': 'Importing {count} rows…',
      'netrefmap.status.done': 'Imported {count} rows.',
      ...
      'blog.tag.local_events': 'Events & Fiestas',
      ...
      'events.hero.title': 'Local Events & Fiestas',
      'events.hero.subtitle': "What's on in Costa Blanca South: fiestas, holidays, and useful local updates.",
      'events.hero.disclaimer': 'Always verify times and locations using the source links.',
      'events.tag.updated_daily': 'Updated daily',
      'events.tag.blog': 'Blog',
      'events.filters.search': 'Search',
      'events.filters.search_placeholder': 'Search events…',
      'events.filters.range': 'Range',
      'events.range.upcoming': 'Upcoming',
      'events.range.last15': 'Last 15 days',
      'events.range.year': 'Next 12 months',
      'events.range.all': 'All',
      'events.filters.type': 'Type',
      'events.kind.all': 'All',
      'events.kind.event': 'Events',
      'events.kind.fiesta': 'Fiestas',
      'events.kind.holiday': 'Holidays',
      'events.kind.update': 'Local updates',
      'events.actions.reload': 'Reload',
      'events.count.items': 'items',
      'events.empty.title': 'No local items yet',
      'events.empty.subtitle': 'This section updates daily. If you just enabled it, the first items will appear after the next sync.',
      'events.updated.label': 'Last updated',
      'events.modal.sources': 'Sources',
      'events.card.open_source': 'Open source',
      ...
      'home.hero.viewing_privileges': 'Signature Viewing Privileges',
      ...
      'home.footer.viewing_privileges': 'Viewing Privileges (Mar–Apr)',
      ...
      'account.tiles.affiliate': 'Earn',
      'account.tiles.affiliate_title': 'Recommend (10%)',
      'account.tiles.affiliate_desc': 'Share links and earn 10% of SCP fees from referred clients.',
      ...
      'account.admin.btn.affiliates': 'Affiliates',
      ...
      'account.admin.network.title': 'Network profiles',
      'account.admin.network.subtitle': 'Suspend a public Network profile (agency/agent/developer/development/collaborator).',
      'account.admin.network.search_placeholder': 'Search network profiles (e.g. adrian, costa-blanca-developments)',
      'account.admin.network.loading': 'Loading network profile states…',
      'account.admin.network.load_failed': 'Failed to load network states: {error}',
      'account.admin.network.showing': 'Showing {count} profiles',
      'account.admin.network.no_match': 'No profiles match your search.',
      'account.admin.network.missing_data': 'Network data not loaded yet.',
      'account.admin.network.empty': 'No network profiles found (load network-data.js first).',
      'account.admin.network.reason_placeholder': 'Reason (optional)',
      'account.admin.network.view': 'View',
      'account.admin.network.saving': 'Saving network state…',
      'account.admin.network.saved': 'Saved network state for {slug}',
      'account.admin.network.save_failed': 'Save failed: {error}',
      'account.admin.claims.title': 'Profile claims',
      'account.admin.claims.subtitle': 'Requests from developers/agencies to edit or delete their public Network profile.',
      'account.admin.claims.search_placeholder': 'Search claims (email, slug, status)',
      'account.admin.claims.showing': 'Showing {count} claims',
      'account.admin.claims.none': 'No claims yet.',
      'account.admin.claims.loading': 'Loading claims…',
      'account.admin.claims.load_failed': 'Failed to load claims: {error}',
      'account.admin.claims.notes_placeholder': 'Admin notes (optional)',
      'account.admin.claims.saving': 'Saving claim…',
      'account.admin.claims.saved': 'Saved.',
      'account.admin.claims.save_failed': 'Save failed: {error}',
      'account.admin.claims.status_new': 'New',
      'account.admin.claims.status_reviewing': 'Reviewing',
      'account.admin.claims.status_approved': 'Approved',
      'account.admin.claims.status_rejected': 'Rejected',
      'account.admin.claims.status_closed': 'Closed',
      'account.admin.newsletter.title': 'Newsletter',
      'account.admin.newsletter.subtitle': 'Send an email update to all users, a role group, or specific emails.',
      'account.admin.newsletter.audience': 'Audience',
      'account.admin.newsletter.audience_all': 'All users',
      'account.admin.newsletter.audience_role': 'By role',
      'account.admin.newsletter.audience_emails': 'Specific emails',
      'account.admin.newsletter.role': 'Role',
      'account.admin.newsletter.emails': 'Emails',
      'account.admin.newsletter.emails_placeholder': 'one@example.com, two@example.com',
      'account.admin.newsletter.subject': 'Subject',
      'account.admin.newsletter.subject_placeholder': 'Monthly update',
      'account.admin.newsletter.body': 'Message',
      'account.admin.newsletter.body_placeholder': 'Write a short, useful update...',
      'account.admin.newsletter.send_test': 'Send test to me',
      'account.admin.newsletter.send': 'Send newsletter',
      'account.admin.newsletter.missing_fields': 'Subject and message are required.',
      'account.admin.newsletter.sending': 'Sending…',
      'account.admin.newsletter.sent': 'Sent. Success: {sent} · Failed: {failed}',
      'account.admin.newsletter.not_deployed': 'Newsletter backend not deployed yet. Deploy the Supabase Edge Function `send-newsletter`.',
      'account.admin.newsletter.failed': 'Send failed: {error}',
      'account.admin.newsletter.no_user': 'Sign in first.',
      'account.admin.newsletter.pick_role': 'Pick a role.',
      'account.admin.newsletter.pick_emails': 'Add at least one email.',
      ...
      'services.collab.subtitle': 'Three collaboration paths: verified partners (agencies, developers, providers), Street Scouts who discover “For Sale” boards, and public affiliate referrals (Recommend & Earn).',
      ...
      'services.collab.affiliate.title': 'Recommend & Earn (10%)',
      'services.collab.affiliate.desc': 'Share listings or services. Earn 10% of SCP fees from referred clients.',
      ...
      'affiliate.nav.back': 'Affiliate',
      'affiliate.hero.title': 'Recommend & Earn (10%)',
      'affiliate.hero.subtitle': 'Share a listing (or our services) with your friends. If your referral becomes a client and pays fees to Spanish Coast Properties, you earn 10% of the revenue.',
      'affiliate.tag.share': 'Share',
      'affiliate.tag.track': 'Tracking',
      'affiliate.tag.earn': 'Earn 10%',
      'affiliate.tag.payout': 'Cash or services',
      'affiliate.cta.open_dashboard': 'Open dashboard',
      'affiliate.cta.terms': 'Program terms',

      'affiliate.how.title': 'How It Works',
      'affiliate.how.1.title': '1) Enable your link',
      'affiliate.how.1.p': 'Create your affiliate code (free). Choose cash or goods/services.',
      'affiliate.how.2.title': '2) Share',
      'affiliate.how.2.p': 'Share any listing, or share your “Buy” / “Sell” links.',
      'affiliate.how.3.title': '3) We attribute',
      'affiliate.how.3.p': 'When the referred client becomes a customer, we attribute their spend to your code.',
      'affiliate.how.4.title': '4) You get 10%',
      'affiliate.how.4.p': 'We return 10% of SCP fees as cash or credit for goods/services.',
      'affiliate.how.note': 'Note: commission is calculated on SCP revenue (fees), not on the property price. Payouts are subject to verification.',

      'affiliate.dashboard.title': 'Affiliate Dashboard',
      'affiliate.auth.title': 'Sign in first',
      'affiliate.auth.p': 'To generate your affiliate code, track earnings, and set payout preferences, sign in (or create a free account).',
      'affiliate.auth.cta': 'Open Account',

      'affiliate.code.title': 'Your affiliate code',
      'affiliate.code.subtitle': 'Use it in shared links: ?aff=CODE',
      'affiliate.code.copy': 'Copy code',
      'affiliate.meta.status': 'Status',
      'affiliate.meta.terms_ok': 'Terms: accepted',
      'affiliate.meta.terms_missing': 'Terms: not accepted yet',

      'affiliate.links.title': 'Share links',
      'affiliate.links.subtitle': 'Copy these links and post them on social media, WhatsApp, email, or anywhere.',
      'affiliate.links.buy': 'Buy link (browse listings)',
      'affiliate.links.sell': 'Sell link (submit a property)',
      'affiliate.links.services': 'Services link',
      'affiliate.links.viewing_privileges': 'Viewing Privileges (campaign)',
      'affiliate.links.viewing_privileges_note': 'Tip: affiliates can add a language for the buyer, e.g. <span class=\"muted\" style=\"font-weight:900;\">?lang=de</span>, <span class=\"muted\" style=\"font-weight:900;\">?lang=nl</span>, or <span class=\"muted\" style=\"font-weight:900;\">?lang=fr</span>.',
      'affiliate.links.listing_ref': 'Listing reference (optional)',
      'affiliate.links.listing_share': 'Listing share page (best for social previews)',
      'affiliate.links.brochure': 'Brochure (PDF)',
      'affiliate.links.reel': 'Reel (Video)',

      'affiliate.earnings.title': 'Earnings',
      'affiliate.earnings.subtitle': 'We show commissions recorded by admin after revenue is confirmed.',
      'affiliate.earnings.th.time': 'Time',
      'affiliate.earnings.th.type': 'Type',
      'affiliate.earnings.th.ref': 'Ref',
      'affiliate.earnings.th.amount': 'Amount',
      'affiliate.earnings.th.commission': 'Commission',
      'affiliate.earnings.th.status': 'Status',
      'affiliate.earnings.th.paid': 'Paid',
      'affiliate.earnings.th.note': 'Note',
      'affiliate.summary.approved': 'Approved',
      'affiliate.summary.pending': 'Pending',
      'affiliate.summary.paid': 'Paid',

      'affiliate.settings.title': 'Settings',
      'affiliate.settings.payout': 'Payout preference',
      'affiliate.settings.payout.cash': 'Cash',
      'affiliate.settings.payout.goods': 'Goods / Services',
      'affiliate.settings.note': 'Payout note (optional)',
      'affiliate.settings.read_terms': 'Read terms',
      'affiliate.settings.accept': 'Accept terms',
      'affiliate.settings.accepting': 'Accepting terms…',
      'affiliate.settings.accepted': 'Terms accepted.',
      'affiliate.settings.accept_failed': 'Accept failed',

      'affiliate.status.supabase_missing': 'Affiliate dashboard unavailable (Supabase not configured).',
      'affiliate.status.load_failed': 'Failed to load affiliate account',
      'affiliate.status.earnings_failed': 'Failed to load earnings',
      'affiliate.status.code_copied': 'Code copied.',
      'affiliate.status.link_copied': 'Link copied.',
      'affiliate.status.copy_failed': 'Copy failed.',

      'affiliate.terms.title': 'Affiliate Program Terms',
      'affiliate.terms.version': 'Version: 2026-02-15',
      'affiliate.terms.overview.title': 'Overview',
      'affiliate.terms.overview.p': 'The Spanish Coast Properties affiliate program lets individuals recommend our services and earn a reward when a referred client generates confirmed revenue for Spanish Coast Properties.',
      'affiliate.terms.eligibility.title': 'Eligibility',
      'affiliate.terms.eligibility.1': 'You must have an active SCP account.',
      'affiliate.terms.eligibility.2': 'Self-referrals are not eligible.',
      'affiliate.terms.eligibility.3': 'We may pause or ban accounts for fraud/abuse.',
      'affiliate.terms.attribution.title': 'Attribution',
      'affiliate.terms.attribution.1': 'Links use the parameter ?aff=CODE.',
      'affiliate.terms.attribution.2': 'Attribution is best-effort and may rely on browser storage.',
      'affiliate.terms.attribution.3': 'If a client contacts us by email/WhatsApp, they should include the referral code when possible.',
      'affiliate.terms.commission.title': 'Commission',
      'affiliate.terms.commission.1': 'Commission rate: 10% of SCP revenue (fees) from the referred client.',
      'affiliate.terms.commission.2': 'Not based on the property sale price.',
      'affiliate.terms.commission.3': 'Taxes, refunds, chargebacks, and third-party costs may reduce eligible revenue.',
      'affiliate.terms.payout.title': 'Payout',
      'affiliate.terms.payout.1': 'Payouts are made after revenue is confirmed and verified.',
      'affiliate.terms.payout.2': 'You can choose cash or goods/services (credit), depending on availability.',
      'affiliate.terms.payout.3': 'We may require an invoice/receipt and identity verification depending on jurisdiction.',
      'affiliate.terms.privacy.title': 'Privacy',
      'affiliate.terms.privacy.p': 'Affiliates see their commission events and totals. We do not share client personal data with affiliates unless explicitly permitted.',
      'affiliate.terms.misc.title': 'Changes & Termination',
      'affiliate.terms.misc.p': 'We may update these terms, change the commission structure, or end the program at any time. If you continue to participate after updates, you accept the new terms.',
      'affiliate.terms.footer.p': 'Affiliate program terms for recommended clients.',

      'affiliate.footer.terms': 'Affiliate program terms',
      'affiliate.footer.services': 'Services',
      'affiliate.footer.p': 'Recommend us and earn 10% of confirmed fees.',
      ...
      'page.viewing_trip.privileges.title': 'Signature Viewing Privileges (Mar 1 – Apr 30, 2026)',
      'page.viewing_trip.privileges.p': 'Reserve a qualifying property during the campaign window and receive completion credits for your viewing trip. New builds include an additional return stay credit. Terms apply.',
      'page.viewing_trip.privileges.cta': 'See the offer',
      'page.viewing_trip.privileges.terms': 'Terms',

      'page.viewing_privileges.hero.title': 'Signature Viewing Privileges',
      'page.viewing_privileges.hero.p': 'A limited Private Client offer for serious buyers. Reserve a qualifying property during the campaign window and receive completion credits for your viewing trip. New builds include an additional return stay credit.',
      'page.viewing_privileges.tag.window': 'Mar 1 – Apr 30, 2026',
      'page.viewing_privileges.tag.completion': 'Paid at completion',
      'page.viewing_privileges.tag.caps': 'Receipt-based caps',
      'page.viewing_privileges.tag.newbuilds_resales': 'New builds + resales',
      'page.viewing_privileges.cta.book_email': 'Book by email',
      'page.viewing_privileges.cta.browse_new_builds': 'Browse new builds',
      'page.viewing_privileges.cta.browse_resales': 'Browse resales',
      'page.viewing_privileges.cta.terms': 'Terms',
      'page.viewing_privileges.hero.note': 'Eligibility is based on a binding reservation/private purchase contract signed within the campaign window. Credits are paid at completion. Limited availability. Terms apply.',
      'page.viewing_privileges.section.newbuilds.title': 'New Builds Privileges',
      'page.viewing_privileges.section.newbuilds.p': 'New build buyers receive two completion credits: a Viewing Trip Credit and a Return Stay Credit. Caps are tied to the purchase price to stay proportional for different budgets. The Return Stay Credit can be used for a second visit here, or as a travel credit elsewhere.',
      'page.viewing_privileges.tier.1.title': '€250k – €399k',
      'page.viewing_privileges.tier.1.p': 'Viewing Trip Credit up to €1,500 + Return Stay Credit up to €750.',
      'page.viewing_privileges.tier.2.title': '€400k – €699k',
      'page.viewing_privileges.tier.2.p': 'Viewing Trip Credit up to €2,500 + Return Stay Credit up to €1,000.',
      'page.viewing_privileges.tier.3.title': '€700k – €999k',
      'page.viewing_privileges.tier.3.p': 'Viewing Trip Credit up to €3,500 + Return Stay Credit up to €1,250.',
      'page.viewing_privileges.tier.4.title': '€1,000,000+',
      'page.viewing_privileges.tier.4.p': 'Viewing Trip Credit up to €5,000 + Return Stay Credit up to €1,500.',
      'page.viewing_privileges.section.newbuilds.note': 'Viewing Trip Credit is receipt-based and paid at completion (not at reservation). Return Stay Credit is issued at completion as a travel credit/voucher (no cash alternative; valid for 12 months). One buying party per purchase.',
      'page.viewing_privileges.section.resales.title': 'Resale Privileges',
      'page.viewing_privileges.section.resales.p': 'For resales, we run a monthly VIP credit during March and April. This is designed to create urgency without turning the market into a discount race.',
      'page.viewing_privileges.resale.vip.title': 'Monthly VIP Viewing Trip Credit',
      'page.viewing_privileges.resale.vip.p': 'In March 2026 and April 2026, the first resale buyer to sign a binding private purchase contract receives a Viewing Trip Credit up to €1,500, paid at completion.',
      'page.viewing_privileges.resale.concierge.title': 'Completion Concierge Pack',
      'page.viewing_privileges.resale.concierge.p': 'All resale buyers who sign during the campaign window receive structured completion support: timeline, notary coordination, and handover planning.',
      'page.viewing_privileges.section.resales.note': 'VIP selection is based on timestamp of signature recorded by Spanish Coast Properties. If the VIP buyer cancels or becomes ineligible, the next eligible buyer in that month is selected.',
      'page.viewing_privileges.section.how.title': 'How It Works',
      'page.viewing_privileges.how.1.title': '1) Book a structured viewing trip',
      'page.viewing_privileges.how.1.p': 'We confirm your budget and must-haves, then build a shortlist and itinerary so the trip stays tight.',
      'page.viewing_privileges.how.2.title': '2) Reserve during the campaign window',
      'page.viewing_privileges.how.2.p': 'To qualify, you must sign a binding reservation/private contract between Mar 1 and Apr 30, 2026.',
      'page.viewing_privileges.how.3.title': '3) Complete and receive credits',
      'page.viewing_privileges.how.3.p': 'At notary completion, we process your eligible credits (up to caps) against receipts.',
      'page.viewing_privileges.section.terms.title': 'Key Terms (Short Version)',
      'page.viewing_privileges.terms.1': 'Credits are paid at completion only (not at reservation).',
      'page.viewing_privileges.terms.2': 'Viewing Trip Credit is receipt-based: flights, accommodation, car hire, and transfers. Excludes meals, upgrades, and non-viewing excursions.',
      'page.viewing_privileges.terms.3': 'Return Stay Credit is issued at completion as a travel credit/voucher (no cash alternative; valid for 12 months), for a second visit here or elsewhere. One buying party per purchase. Caps apply by tier (new builds) and monthly VIP cap applies for resales.',
      'page.viewing_privileges.terms.4': 'Campaign window: Mar 1 to Apr 30, 2026 (CET/CEST). Completion may occur after the window.',
      'page.viewing_privileges.terms.5': 'Limited availability and may end early if capacity is reached. Terms apply.',
      'page.viewing_privileges.cta.read_full_terms': 'Read full terms',
      'page.viewing_privileges.cta.viewing_trip_package': 'Viewing trip package',
      'page.viewing_privileges.footer.p': 'Private Client viewing trips that turn browsing into a confident purchase decision.',

      'page.viewing_privileges_terms.hero.title': 'Signature Viewing Privileges Terms',
      'page.viewing_privileges_terms.hero.p': 'These terms apply to the Signature Viewing Privileges campaign run by Spanish Coast Properties. Credits are paid at completion only.',
      'page.viewing_privileges_terms.tag.window': 'Campaign window: Mar 1 – Apr 30, 2026',
      'page.viewing_privileges_terms.tag.region': 'CET/CEST',
      'page.viewing_privileges_terms.tag.paid': 'Paid at completion',
      'page.viewing_privileges_terms.hero.note': 'If translations are shown for convenience, the English version is the reference version in case of conflict.',
      'page.viewing_privileges_terms.cta.back': 'Back to offer',
      'page.viewing_privileges_terms.cta.email': 'Ask by email',
      'page.viewing_privileges_terms.cta.book': 'Book by email',
      'page.viewing_privileges_terms.section.definitions.title': '1) Definitions',
      'page.viewing_privileges_terms.def.1': '<strong>Buying party</strong>: one household / group buying the property together.',
      'page.viewing_privileges_terms.def.2': '<strong>Campaign window</strong>: from March 1, 2026 to April 30, 2026 (CET/CEST), inclusive.',
      'page.viewing_privileges_terms.def.3': '<strong>Binding contract</strong>: a signed reservation / private purchase contract that is binding under the agreed terms, with required deposits paid.',
      'page.viewing_privileges_terms.def.4': '<strong>Completion</strong>: notary completion (escritura) of the qualifying purchase.',
      'page.viewing_privileges_terms.def.5': '<strong>Credits</strong>: completion credits paid at completion (not at reservation), subject to caps and receipts.',
      'page.viewing_privileges_terms.section.eligibility.title': '2) Eligibility',
      'page.viewing_privileges_terms.elig.1': 'To qualify, the buying party must sign a binding contract for a qualifying property during the campaign window.',
      'page.viewing_privileges_terms.elig.2': 'Credits are paid only if the purchase completes at notary. If the purchase does not complete, no credits are payable.',
      'page.viewing_privileges_terms.elig.3': 'Viewings must be arranged or confirmed through Spanish Coast Properties for expenses to be eligible.',
      'page.viewing_privileges_terms.elig.4': 'One set of credits per buying party per purchase. Credits are not transferable.',
      'page.viewing_privileges_terms.section.newbuilds.title': '3) New Builds Credits (Tiered Caps)',
      'page.viewing_privileges_terms.section.newbuilds.p': 'New build buyers may receive two credits: Viewing Trip Credit and Return Stay Credit. Caps depend on purchase price.',
      'page.viewing_privileges_terms.section.newbuilds.note': 'Viewing Trip Credit is reimbursed at completion against receipts (up to caps). Return Stay Credit is issued at completion as a travel credit/voucher (no cash alternative), valid for 12 months.',
      'page.viewing_privileges_terms.tier.1.title': '€250k – €399k',
      'page.viewing_privileges_terms.tier.1.p': 'Viewing Trip Credit up to €1,500 + Return Stay Credit up to €750.',
      'page.viewing_privileges_terms.tier.2.title': '€400k – €699k',
      'page.viewing_privileges_terms.tier.2.p': 'Viewing Trip Credit up to €2,500 + Return Stay Credit up to €1,000.',
      'page.viewing_privileges_terms.tier.3.title': '€700k – €999k',
      'page.viewing_privileges_terms.tier.3.p': 'Viewing Trip Credit up to €3,500 + Return Stay Credit up to €1,250.',
      'page.viewing_privileges_terms.tier.4.title': '€1,000,000+',
      'page.viewing_privileges_terms.tier.4.p': 'Viewing Trip Credit up to €5,000 + Return Stay Credit up to €1,500.',
      'page.viewing_privileges_terms.section.resales.title': '4) Resale Credits (Monthly VIP)',
      'page.viewing_privileges_terms.resale.1': 'In March 2026 and April 2026, the first resale buyer to sign a binding private purchase contract (timestamp recorded by Spanish Coast Properties) receives a Viewing Trip Credit up to €1,500, paid at completion.',
      'page.viewing_privileges_terms.resale.2': 'If the VIP buyer cancels, becomes ineligible, or does not complete, the next eligible buyer in that month is selected.',
      'page.viewing_privileges_terms.resale.3': 'All resale buyers who sign during the campaign window receive the Completion Concierge Pack (non-monetary operational support).',
      'page.viewing_privileges_terms.section.expenses.title': '5) Eligible Expenses (Viewing Trip Credit)',
      'page.viewing_privileges_terms.section.expenses.p': 'Viewing Trip Credit is receipt-based and limited to documented eligible costs, up to the relevant cap(s).',
      'page.viewing_privileges_terms.exp.1': '<strong>Included</strong>: flights/train, accommodation, car hire, airport transfers, and local transport directly related to the viewing trip.',
      'page.viewing_privileges_terms.exp.2': '<strong>Excluded</strong>: meals, upgrades, shopping, entertainment, non-viewing excursions, and costs not supported by receipts.',
      'page.viewing_privileges_terms.exp.3': 'Receipts must be in the buyer’s name (or clearly attributable to the buying party) and provided on request.',
      'page.viewing_privileges_terms.section.payment.title': '6) Payment & Processing',
      'page.viewing_privileges_terms.pay.1': 'Credits are paid at completion only. Typical processing is within 10 business days after completion and receipt verification.',
      'page.viewing_privileges_terms.pay.2': 'Payment method may be bank transfer and/or credit against any Spanish Coast Properties invoice, at our discretion.',
      'page.viewing_privileges_terms.pay.3': 'If receipts are in a non-EUR currency, amounts may be converted to EUR using a reasonable reference rate.',
      'page.viewing_privileges_terms.section.general.title': '7) General',
      'page.viewing_privileges_terms.gen.1': 'This offer cannot be exchanged for cash beyond the value of eligible, documented costs and applicable caps.',
      'page.viewing_privileges_terms.gen.2': 'The offer may be withdrawn or ended early if capacity is reached or if abuse/fraud is suspected.',
      'page.viewing_privileges_terms.gen.3': 'Spanish Coast Properties may refuse payment of credits where eligibility conditions are not met.',
      'page.viewing_privileges_terms.footer.p': 'Signature Viewing Privileges are designed to underwrite serious buyers’ due diligence.',
      ...
      'account.profile.close': 'Close',
      'account.profile.display_name': 'Display name',
      'account.profile.display_name_placeholder': 'Your name',
      'account.profile.avatar_upload': 'Upload profile image',
      'account.profile.avatar_upload_note': 'Optional. If upload is not enabled yet, paste an image URL below.',
      'account.profile.avatar_url': 'Profile image URL',
      'account.profile.avatar_url_placeholder': 'https://…',
      'account.profile.languages': 'Spoken languages',
      'account.profile.languages_note': 'Choose the languages you can communicate in.',
      'account.profile.save': 'Save',
      'account.profile.sign_in_first': 'Please sign in first.',
      'account.profile.avatar_ready': 'Image selected. Tap Save to upload.',
    ...
    es: {
      ...
      'network.hero.title': 'Red',
      'network.hero.subtitle': 'Agencias, agentes, promotores, promociones y colaboradores verificados en Costa Blanca Sur.',
      'network.cta.join': 'Solicitar colaboración',
      'network.cta.services': 'Ver servicios',
      'network.cta.whatsapp': 'WhatsApp',
      'network.cta.website': 'Web',
      'network.filters.search': 'Buscar',
      'network.filters.search_placeholder': 'Buscar perfiles…',
      'network.filters.type': 'Tipo',
      'network.kind.agencies': 'Agencias',
      'network.kind.agents': 'Agentes',
      'network.kind.developers': 'Promotores',
      'network.kind.developments': 'Promociones',
      'network.kind.collaborators': 'Colaboradores',
      'network.kind.agency': 'Agencia',
      'network.kind.agent': 'Agente',
      'network.kind.developer': 'Promotor',
      'network.kind.development': 'Promoción',
      'network.kind.collaborator': 'Colaborador',
      'network.verified': 'Verificado',
      'network.suspended': 'Suspendido',
      'network.suspended_reason_unknown': 'Sin motivo.',
      'network.count': '{n} perfiles',
      'network.empty.title': 'Aún no hay perfiles',
      'network.empty.subtitle': 'Añade perfiles en network-data.js.',
      'network.card.open_hint': 'Toca la tarjeta para abrir el perfil',
      'network.card.open_aria': 'Abrir perfil: {name}',
      'network.profile.back': '← Volver a la Red',
      'network.profile.unknown': 'Perfil',
      'network.profile.loading': 'Cargando…',
      'network.profile.loading_subtitle': 'Preparando perfil…',
      'network.profile.suspended_title': 'Perfil no disponible',
      'network.profile.suspended_subtitle': 'Este perfil no está disponible en este momento.',
      'network.profile.not_found_title': 'Perfil no encontrado',
      'network.profile.not_found_subtitle': 'Vuelve al directorio de la Red para elegir un perfil.',
      'network.profile.contact': 'Contacto',
      'network.profile.quick_facts': 'Datos rápidos',
      'network.profile.location': 'Ubicación',
      'network.profile.languages': 'Idiomas',
      'network.profile.ref': 'Referencia',
      'network.profile.source_ref': 'Ref. fuente',
      'network.profile.source_ref_btn': 'Mostrar',
      'network.profile.source_ref_loading': 'Cargando…',
      'network.profile.source_ref_copy': 'Copiar',
      'network.profile.source_ref_copied': 'Copiado',
      'network.profile.source_ref_not_found': 'No encontrada',
      'network.profile.source_ref_table_missing': 'Falta tabla',
      'network.profile.source_ref_admin_only': 'Solo admin',
      'network.profile.source_ref_failed': 'Error',
      'network.profile.source_refs': 'Referencias fuente',
      'network.profile.about': 'Sobre',
      'network.profile.no_bio': 'Sin descripción todavía.',
      'network.profile.relationships': 'Relaciones',
      'network.profile.agent_of_agency': 'Agencia',
      'network.profile.agent_of_developer': 'Promotor',
      'network.profile.development_developer': 'Promotor',
      'network.profile.agency_agents': 'Agentes de esta agencia',
      'network.profile.developer_developments': 'Promociones',
      'network.profile.developer_agents': 'Agentes del promotor',
      'network.profile.no_relationships': 'Aún no hay relaciones definidas.',
      'network.profile.claim.title': '¿Eres el propietario de este perfil?',
      'network.profile.claim.subtitle': 'Si representas este perfil, puedes solicitar editarlo o eliminarlo.',
      'network.profile.claim.open_btn': 'Solicitar control',
      'network.profile.claim.email_btn': 'Envíanos un correo',
      'network.profile.claim.action': 'Acción',
      'network.profile.claim.action_edit': 'Editar este perfil',
      'network.profile.claim.action_delete': 'Eliminar este perfil',
      'network.profile.claim.name': 'Tu nombre',
      'network.profile.claim.name_placeholder': 'Tu nombre completo',
      'network.profile.claim.email': 'Tu correo',
      'network.profile.claim.email_placeholder': 'tú@empresa.com',
      'network.profile.claim.message': 'Mensaje',
      'network.profile.claim.message_placeholder': 'Añade pruebas (web, teléfono, rol) y lo que quieres cambiar…',
      'network.profile.claim.submit': 'Enviar solicitud',
      'network.profile.claim.sending': 'Enviando…',
      'network.profile.claim.sent': 'Solicitud enviada. Te responderemos por correo.',
      'network.profile.claim.invalid_email': 'Introduce un correo válido.',
      'network.profile.claim.sign_in_required': 'Inicia sesión primero en Cuenta y vuelve a enviar.',
      'network.profile.claim.no_client': 'El cliente de Supabase no está disponible en esta página.',
      'network.profile.claim.table_missing': 'Falta la tabla de solicitudes. Admin: ejecuta `supabase_network_claims.sql` en el editor SQL de Supabase.',
      'network.profile.claim.failed': 'No se pudo enviar: {error}',
      'network.footer.p': 'Red local para Costa Blanca Sur: agencias, agentes, promotores y colaboradores verificados.',
      ...
      'blog.tag.local_events': 'Eventos y Fiestas',
      ...
      'events.hero.title': 'Eventos y Fiestas',
      'events.hero.subtitle': 'Qué hay en Costa Blanca Sur: fiestas, festivos y avisos locales útiles.',
      'events.hero.disclaimer': 'Confirma horarios y ubicaciones usando los enlaces de la fuente.',
      'events.tag.updated_daily': 'Actualizado a diario',
      'events.tag.blog': 'Blog',
      'events.filters.search': 'Buscar',
      'events.filters.search_placeholder': 'Buscar eventos…',
      'events.filters.range': 'Rango',
      'events.range.upcoming': 'Próximamente',
      'events.range.last15': 'Últimos 15 días',
      'events.range.year': 'Próximos 12 meses',
      'events.range.all': 'Todo',
      'events.filters.type': 'Tipo',
      'events.kind.all': 'Todo',
      'events.kind.event': 'Eventos',
      'events.kind.fiesta': 'Fiestas',
      'events.kind.holiday': 'Festivos',
      'events.kind.update': 'Avisos locales',
      'events.actions.reload': 'Recargar',
      'events.count.items': 'elementos',
      'events.empty.title': 'Aún no hay elementos',
      'events.empty.subtitle': 'Esta sección se actualiza a diario. Si la acabas de activar, los primeros elementos aparecerán después de la próxima sincronización.',
      'events.updated.label': 'Última actualización',
      'events.modal.sources': 'Fuentes',
      'events.card.open_source': 'Abrir fuente',
      ...
      'account.tiles.affiliate': 'Gana',
      'account.tiles.affiliate_title': 'Recomienda (10%)',
      'account.tiles.affiliate_desc': 'Comparte enlaces y gana el 10% de las comisiones de SCP de clientes referidos.',
      'account.tiles.admin': 'Admin',
      ...
      'account.admin.btn.affiliates': 'Afiliados',
      ...
      'account.admin.network.title': 'Perfiles de la red',
      'account.admin.network.subtitle': 'Suspende un perfil público de la Red (agencia/agente/promotor/promoción/colaborador).',
      'account.admin.network.search_placeholder': 'Buscar perfiles de red (p.ej. adrian, costa-blanca-developments)',
      'account.admin.network.loading': 'Cargando estados de perfiles…',
      'account.admin.network.load_failed': 'Error al cargar estados de la red: {error}',
      'account.admin.network.showing': 'Mostrando {count} perfiles',
      'account.admin.network.no_match': 'No hay perfiles que coincidan con tu búsqueda.',
      'account.admin.network.missing_data': 'Aún no se han cargado los datos de la red.',
      'account.admin.network.empty': 'No se encontraron perfiles de red (carga network-data.js primero).',
      'account.admin.network.reason_placeholder': 'Motivo (opcional)',
      'account.admin.network.view': 'Ver',
      'account.admin.network.saving': 'Guardando estado de red…',
      'account.admin.network.saved': 'Estado guardado para {slug}',
      'account.admin.network.save_failed': 'Error al guardar: {error}',
      'account.admin.newsletter.title': 'Boletín',
      'account.admin.newsletter.subtitle': 'Envía una actualización por correo a todos los usuarios, a un grupo por rol, o a correos específicos.',
      'account.admin.newsletter.audience': 'Audiencia',
      'account.admin.newsletter.audience_all': 'Todos los usuarios',
      'account.admin.newsletter.audience_role': 'Por rol',
      'account.admin.newsletter.audience_emails': 'Correos específicos',
      'account.admin.newsletter.role': 'Rol',
      'account.admin.newsletter.emails': 'Correos',
      'account.admin.newsletter.emails_placeholder': 'uno@ejemplo.com, dos@ejemplo.com',
      'account.admin.newsletter.subject': 'Asunto',
      'account.admin.newsletter.subject_placeholder': 'Actualización mensual',
      'account.admin.newsletter.body': 'Mensaje',
      'account.admin.newsletter.body_placeholder': 'Escribe una actualización corta y útil...',
      'account.admin.newsletter.send_test': 'Enviar prueba a mi',
      'account.admin.newsletter.send': 'Enviar boletín',
      'account.admin.newsletter.missing_fields': 'Asunto y mensaje son obligatorios.',
      'account.admin.newsletter.sending': 'Enviando…',
      'account.admin.newsletter.sent': 'Enviado. Éxito: {sent} · Fallidos: {failed}',
      'account.admin.newsletter.not_deployed': 'Backend del boletín aún no desplegado. Despliega la función Edge de Supabase `send-newsletter`.',
      'account.admin.newsletter.failed': 'Error al enviar: {error}',
      'account.admin.newsletter.no_user': 'Inicia sesión primero.',
      'account.admin.newsletter.pick_role': 'Elige un rol.',
      'account.admin.newsletter.pick_emails': 'Añade al menos un correo.',
      ...
      'services.collab.subtitle': 'Tres vias: colaboradores verificados (agencias, promotores, proveedores), Street Scouts que encuentran carteles de venta y afiliados publicos (Recomienda y gana).',
      ...
      'services.collab.affiliate.title': 'Recomienda y gana (10%)',
      'services.collab.affiliate.desc': 'Comparte anuncios o servicios. Gana el 10% de las comisiones de SCP de clientes referidos.',
      ...
      'account.profile.edit': 'Editar perfil',
      'account.profile.close': 'Cerrar',
      'account.profile.display_name': 'Nombre',
      'account.profile.display_name_placeholder': 'Tu nombre',
      'account.profile.avatar_upload': 'Subir imagen de perfil',
      'account.profile.avatar_upload_note': 'Opcional. Si la subida no está habilitada aún, pega una URL abajo.',
      'account.profile.avatar_url': 'URL de imagen de perfil',
      'account.profile.avatar_url_placeholder': 'https://…',
      'account.profile.languages': 'Idiomas hablados',
      'account.profile.languages_note': 'Elige los idiomas en los que puedes comunicarte.',
      'account.profile.save': 'Guardar',
      'account.profile.sign_in_first': 'Por favor, inicia sesión primero.',
      'account.profile.avatar_ready': 'Imagen seleccionada. Pulsa Guardar para subirla.',
  ...
  const MANUAL_LOCALES = {
    ro: {
      ...
      'network.hero.title': 'Rețea',
      'network.hero.subtitle': 'Agenții, agenți, dezvoltatori, dezvoltări și colaboratori verificați în Costa Blanca South.',
      'network.cta.join': 'Aplică pentru înscriere',
      'network.cta.services': 'Vezi servicii',
      'network.cta.whatsapp': 'WhatsApp',
      'network.cta.website': 'Site',
      'network.filters.search': 'Caută',
      'network.filters.search_placeholder': 'Caută profiluri…',
      'network.filters.type': 'Tip',
      'network.kind.agencies': 'Agenții',
      'network.kind.agents': 'Agenți',
      'network.kind.developers': 'Dezvoltatori',
      'network.kind.developments': 'Dezvoltări',
      'network.kind.collaborators': 'Colaboratori',
      'network.kind.agency': 'Agenție',
      'network.kind.agent': 'Agent',
      'network.kind.developer': 'Dezvoltator',
      'network.kind.development': 'Dezvoltare',
      'network.kind.collaborator': 'Colaborator',
      'network.verified': 'Verificat',
      'network.suspended': 'Suspendat',
      'network.suspended_reason_unknown': 'Fără motiv.',
      'network.count': '{n} profiluri',
      'network.empty.title': 'Încă nu există profiluri',
      'network.empty.subtitle': 'Adaugă profiluri în network-data.js.',
      'network.card.open_hint': 'Atinge cardul pentru a deschide profilul',
      'network.card.open_aria': 'Deschide profilul: {name}',
      'network.profile.back': '← Înapoi la Rețea',
      'network.profile.unknown': 'Profil',
      'network.profile.loading': 'Se încarcă…',
      'network.profile.loading_subtitle': 'Se pregătește profilul…',
      'network.profile.suspended_title': 'Profil indisponibil',
      'network.profile.suspended_subtitle': 'Acest profil nu este disponibil momentan.',
      'network.profile.not_found_title': 'Profil negăsit',
      'network.profile.not_found_subtitle': 'Întoarce-te la directorul Rețea pentru a alege un profil.',
      'network.profile.contact': 'Contact',
      'network.profile.quick_facts': 'Date rapide',
      'network.profile.location': 'Locație',
      'network.profile.languages': 'Limbi',
      'network.profile.ref': 'Referință',
      'network.profile.source_ref': 'Referință sursă',
      'network.profile.source_ref_btn': 'Arată',
      'network.profile.source_ref_loading': 'Se încarcă…',
      'network.profile.source_ref_copy': 'Copiază',
      'network.profile.source_ref_copied': 'Copiat',
      'network.profile.source_ref_not_found': 'Nu a fost găsit',
      'network.profile.source_ref_table_missing': 'Lipsește tabela',
      'network.profile.source_ref_admin_only': 'Doar admin',
      'network.profile.source_ref_failed': 'Eșuat',
      'network.profile.source_refs': 'Referințe sursă',
      'network.profile.about': 'Despre',
      'network.profile.no_bio': 'Încă nu există descriere.',
      'network.profile.relationships': 'Relații',
      'network.profile.agent_of_agency': 'Agenție',
      'network.profile.agent_of_developer': 'Dezvoltator',
      'network.profile.development_developer': 'Dezvoltator',
      'network.profile.agency_agents': 'Agenți în această agenție',
      'network.profile.developer_developments': 'Dezvoltări',
      'network.profile.developer_agents': 'Agenți ai dezvoltatorului',
      'network.profile.no_relationships': 'Încă nu sunt definite relații.',
      'network.footer.p': 'Rețea locală pentru Costa Blanca South: agenții, agenți, dezvoltatori și colaboratori verificați.',
      'role.admin': 'Admin',
      ...
      'account.profile.close': 'Închide',
      'account.profile.display_name': 'Nume afișat',
      'account.profile.display_name_placeholder': 'Numele tău',
      'account.profile.avatar_upload': 'Încarcă imagine de profil',
      'account.profile.avatar_upload_note': 'Opțional. Dacă încărcarea nu e disponibilă încă, lipește un URL mai jos.',
      'account.profile.avatar_url': 'URL imagine de profil',
      'account.profile.avatar_url_placeholder': 'https://…',
      'account.profile.languages': 'Limbi vorbite',
      'account.profile.languages_note': 'Alege limbile în care poți comunica.',
      'account.profile.save': 'Salvează',
      'account.profile.sign_in_first': 'Te rog autentifică-te mai întâi.',
      'account.profile.avatar_ready': 'Imagine selectată. Apasă Salvează pentru a o încărca.',
      ...
      'account.admin.network.title': 'Profiluri din rețea',
      'account.admin.network.subtitle': 'Suspendă un profil public din Rețea (agenție/agent/dezvoltator/proiect/colaborator).',
      'account.admin.network.search_placeholder': 'Caută profiluri din rețea (ex. adrian, costa-blanca-developments)',
      'account.admin.network.loading': 'Se încarcă stările profilurilor…',
      'account.admin.network.load_failed': 'Nu s-au putut încărca stările rețelei: {error}',
      'account.admin.network.showing': 'Afișare {count} profiluri',
      'account.admin.network.no_match': 'Niciun profil nu corespunde căutării.',
      'account.admin.network.missing_data': 'Datele rețelei nu sunt încă încărcate.',
      'account.admin.network.empty': 'Nu s-au găsit profiluri (încarcă mai întâi network-data.js).',
      'account.admin.network.reason_placeholder': 'Motiv (opțional)',
      'account.admin.network.view': 'Vezi',
      'account.admin.network.saving': 'Se salvează starea…',
      'account.admin.network.saved': 'Stare salvată pentru {slug}',
      'account.admin.network.save_failed': 'Salvare eșuată: {error}',
      'account.admin.newsletter.title': 'Newsletter',
      'account.admin.newsletter.subtitle': 'Trimite un email către toți utilizatorii, un grup pe rol sau adrese specifice.',
      'account.admin.newsletter.audience': 'Audiență',
      'account.admin.newsletter.audience_all': 'Toți utilizatorii',
      'account.admin.newsletter.audience_role': 'După rol',
      'account.admin.newsletter.audience_emails': 'Emailuri specifice',
      'account.admin.newsletter.role': 'Rol',
      'account.admin.newsletter.emails': 'Emailuri',
      'account.admin.newsletter.emails_placeholder': 'unu@exemplu.com, doi@exemplu.com',
      'account.admin.newsletter.subject': 'Subiect',
      'account.admin.newsletter.subject_placeholder': 'Actualizare lunară',
      'account.admin.newsletter.body': 'Mesaj',
      'account.admin.newsletter.body_placeholder': 'Scrie o actualizare scurtă și utilă...',
      'account.admin.newsletter.send_test': 'Trimite test către mine',
      'account.admin.newsletter.send': 'Trimite newsletter',
      'account.admin.newsletter.missing_fields': 'Subiectul și mesajul sunt obligatorii.',
      'account.admin.newsletter.sending': 'Se trimite…',
      'account.admin.newsletter.sent': 'Trimis. Reușite: {sent} · Eșuate: {failed}',
      'account.admin.newsletter.not_deployed': 'Backend-ul pentru newsletter nu este încă instalat. Publică funcția Supabase Edge `send-newsletter`.',
      'account.admin.newsletter.failed': 'Trimitere eșuată: {error}',
      'account.admin.newsletter.no_user': 'Autentifică-te mai întâi.',
      'account.admin.newsletter.pick_role': 'Alege un rol.',
      'account.admin.newsletter.pick_emails': 'Adaugă cel puțin un email.',
      ...
      'services.collab.subtitle': 'Trei căi de colaborare: parteneri verificați (agenții, dezvoltatori, furnizori), Street Scouts care descoperă panouri „De vânzare” și afiliere publică (Recomandă și câștigă).',
    ...
    sv: {
      ...
      'network.hero.title': 'Nätverk',
      'network.hero.subtitle': 'Byråer, agenter, utvecklare, projekt och verifierade samarbetspartner på Costa Blanca South.',
      'network.cta.join': 'Ansök om att gå med',
      'network.cta.services': 'Se tjänster',
      'network.cta.whatsapp': 'WhatsApp',
      'network.cta.website': 'Webbplats',
      'network.filters.search': 'Sök',
      'network.filters.search_placeholder': 'Sök profiler…',
      'network.filters.type': 'Typ',
      'network.kind.agencies': 'Byråer',
      'network.kind.agents': 'Agenter',
      'network.kind.developers': 'Utvecklare',
      'network.kind.developments': 'Projekt',
      'network.kind.collaborators': 'Samarbetspartner',
      'network.kind.agency': 'Byrå',
      'network.kind.agent': 'Agent',
      'network.kind.developer': 'Utvecklare',
      'network.kind.development': 'Projekt',
      'network.kind.collaborator': 'Samarbetspartner',
      'network.verified': 'Verifierad',
      'network.suspended': 'Suspenderad',
      'network.suspended_reason_unknown': 'Ingen anledning angiven.',
      'network.count': '{n} profiler',
      'network.empty.title': 'Inga profiler ännu',
      'network.empty.subtitle': 'Lägg till profiler i network-data.js.',
      'network.card.open_hint': 'Tryck på kortet för att öppna profilen',
      'network.card.open_aria': 'Öppna profil: {name}',
      'network.profile.back': '← Tillbaka till Nätverk',
      'network.profile.unknown': 'Profil',
      'network.profile.loading': 'Laddar…',
      'network.profile.loading_subtitle': 'Förbereder profil…',
      'network.profile.suspended_title': 'Profilen är inte tillgänglig',
      'network.profile.suspended_subtitle': 'Den här profilen är för närvarande inte tillgänglig.',
      'network.profile.not_found_title': 'Profilen hittades inte',
      'network.profile.not_found_subtitle': 'Gå tillbaka till Nätverk-katalogen för att välja en profil.',
      'network.profile.contact': 'Kontakt',
      'network.profile.quick_facts': 'Snabbfakta',
      'network.profile.location': 'Plats',
      'network.profile.languages': 'Språk',
      'network.profile.ref': 'Referens',
      'network.profile.source_ref': 'Källreferens',
      'network.profile.source_ref_btn': 'Visa',
      'network.profile.source_ref_loading': 'Laddar…',
      'network.profile.source_ref_copy': 'Kopiera',
      'network.profile.source_ref_copied': 'Kopierad',
      'network.profile.source_ref_not_found': 'Hittades inte',
      'network.profile.source_ref_table_missing': 'Saknar tabell',
      'network.profile.source_ref_admin_only': 'Endast admin',
      'network.profile.source_ref_failed': 'Misslyckades',
      'network.profile.source_refs': 'Källreferenser',
      'network.profile.about': 'Om',
      'network.profile.no_bio': 'Ingen beskrivning ännu.',
      'network.profile.relationships': 'Relationer',
      'network.profile.agent_of_agency': 'Byrå',
      'network.profile.agent_of_developer': 'Utvecklare',
      'network.profile.development_developer': 'Utvecklare',
      'network.profile.agency_agents': 'Agenter i denna byrå',
      'network.profile.developer_developments': 'Projekt',
      'network.profile.developer_agents': 'Utvecklarens agenter',
      'network.profile.no_relationships': 'Inga relationer definierade ännu.',
      'network.footer.p': 'Lokalt nätverk för Costa Blanca South: byråer, agenter, utvecklare och verifierade samarbetspartner.',
      'role.admin': 'Admin',
      'role.partner': 'Partner',
      ...
      'account.profile.edit': 'Redigera profil',
      'account.profile.close': 'Stäng',
      'account.profile.display_name': 'Visningsnamn',
      'account.profile.display_name_placeholder': 'Ditt namn',
      'account.profile.avatar_upload': 'Ladda upp profilbild',
      'account.profile.avatar_upload_note': 'Valfritt. Om uppladdning inte är aktiverad än, klistra in en bild-URL nedan.',
      'account.profile.avatar_url': 'Profilbild-URL',
      'account.profile.avatar_url_placeholder': 'https://…',
      'account.profile.languages': 'Språk du talar',
      'account.profile.languages_note': 'Välj språken du kan kommunicera på.',
      'account.profile.save': 'Spara',
      'account.profile.sign_in_first': 'Logga in först.',
      'account.profile.avatar_ready': 'Bild vald. Tryck på Spara för att ladda upp.',
      ...
      'account.admin.network.title': 'Nätverksprofiler',
      'account.admin.network.subtitle': 'Stäng av en offentlig Nätverksprofil (byrå/agent/utvecklare/projekt/samarbetspartner).',
      'account.admin.network.search_placeholder': 'Sök nätverksprofiler (t.ex. adrian, costa-blanca-developments)',
      'account.admin.network.loading': 'Laddar nätverksstatus…',
      'account.admin.network.load_failed': 'Kunde inte ladda nätverksstatus: {error}',
      'account.admin.network.showing': 'Visar {count} profiler',
      'account.admin.network.no_match': 'Inga profiler matchar din sökning.',
      'account.admin.network.missing_data': 'Nätverksdata är inte laddad än.',
      'account.admin.network.empty': 'Inga nätverksprofiler hittades (ladda network-data.js först).',
      'account.admin.network.reason_placeholder': 'Orsak (valfritt)',
      'account.admin.network.view': 'Visa',
      'account.admin.network.saving': 'Sparar nätverksstatus…',
      'account.admin.network.saved': 'Sparade nätverksstatus för {slug}',
      'account.admin.network.save_failed': 'Sparandet misslyckades: {error}',
      'account.admin.newsletter.title': 'Nyhetsbrev',
      'account.admin.newsletter.subtitle': 'Skicka en uppdatering via e-post till alla användare, en rollgrupp eller specifika adresser.',
      'account.admin.newsletter.audience': 'Målgrupp',
      'account.admin.newsletter.audience_all': 'Alla användare',
      'account.admin.newsletter.audience_role': 'Efter roll',
      'account.admin.newsletter.audience_emails': 'Specifika e-postadresser',
      'account.admin.newsletter.role': 'Roll',
      'account.admin.newsletter.emails': 'E-post',
      'account.admin.newsletter.emails_placeholder': 'en@exempel.se, två@exempel.se',
      'account.admin.newsletter.subject': 'Ämne',
      'account.admin.newsletter.subject_placeholder': 'Månadsuppdatering',
      'account.admin.newsletter.body': 'Meddelande',
      'account.admin.newsletter.body_placeholder': 'Skriv en kort, nyttig uppdatering...',
      'account.admin.newsletter.send_test': 'Skicka test till mig',
      'account.admin.newsletter.send': 'Skicka nyhetsbrev',
      'account.admin.newsletter.missing_fields': 'Ämne och meddelande krävs.',
      'account.admin.newsletter.sending': 'Skickar…',
      'account.admin.newsletter.sent': 'Skickat. Lyckades: {sent} · Misslyckades: {failed}',
      'account.admin.newsletter.not_deployed': 'Backend för nyhetsbrev är inte publicerad än. Publicera Supabase Edge-funktionen `send-newsletter`.',
      'account.admin.newsletter.failed': 'Skickning misslyckades: {error}',
      'account.admin.newsletter.no_user': 'Logga in först.',
      'account.admin.newsletter.pick_role': 'Välj en roll.',
      'account.admin.newsletter.pick_emails': 'Lägg till minst en e-postadress.',
      ...
      'services.collab.subtitle': 'Tre samarbetsvägar: verifierade partners (byråer, utvecklare, leverantörer), Street Scouts som hittar ”Till salu”-skyltar och offentlig affiliate (Rekommendera och tjäna).',
    ...
    no: {
      ...
      'common.all': 'Alle',
      'common.na': 'N/A',
      'common.price_on_request': 'Pris på forespørsel',
      'common.per_night': 'natt',
      'common.per_day': 'dag',
      'common.per_week': 'uke',
      'common.per_month': 'måned',
      'common.copy': 'Kopier',
      'common.open': 'Åpne',
      'common.back_to_account': 'Tilbake til konto',
      'common.refresh': 'Oppdater',
      'common.export_csv': 'Eksporter CSV',
      'common.save': 'Lagre',
      'common.saving': 'Lagrer…',
      'common.saved': 'Lagret.',
      'common.save_failed': 'Lagring mislyktes',
      'nav.home': 'Hjem',
      'nav.properties': 'Eiendommer',
      'nav.new_builds': 'Nybygg',
      'nav.businesses': 'Bedrifter',
      'nav.vehicles': 'Kjøretøy',
      'nav.services': 'Tjenester',
      'nav.blog': 'Blogg',
      'nav.network': 'Nettverk',
      'nav.account': 'Konto',
      'nav.contact_us': 'Kontakt oss',
      'nav.email': 'E-post',
      'nav.call': 'Ring',
      ...
      'network.hero.title': 'Nettverk',
      'network.hero.subtitle': 'Byråer, agenter, utviklere, prosjekter og verifiserte samarbeidspartnere på Costa Blanca South.',
      'network.cta.join': 'Søk om å bli med',
      'network.cta.services': 'Se tjenester',
      'network.cta.whatsapp': 'WhatsApp',
      'network.cta.website': 'Nettside',
      'network.filters.search': 'Søk',
      'network.filters.search_placeholder': 'Søk profiler…',
      'network.filters.type': 'Type',
      'network.kind.agencies': 'Byråer',
      'network.kind.agents': 'Agenter',
      'network.kind.developers': 'Utviklere',
      'network.kind.developments': 'Prosjekter',
      'network.kind.collaborators': 'Samarbeidspartnere',
      'network.kind.agency': 'Byrå',
      'network.kind.agent': 'Agent',
      'network.kind.developer': 'Utvikler',
      'network.kind.development': 'Prosjekt',
      'network.kind.collaborator': 'Samarbeidspartner',
      'network.verified': 'Verifisert',
      'network.suspended': 'Suspendert',
      'network.suspended_reason_unknown': 'Ingen grunn oppgitt.',
      'network.count': '{n} profiler',
      'network.empty.title': 'Ingen profiler ennå',
      'network.empty.subtitle': 'Legg til profiler i network-data.js.',
      'network.card.open_hint': 'Trykk på kortet for å åpne profilen',
      'network.card.open_aria': 'Åpne profil: {name}',
      'network.profile.back': '← Tilbake til Nettverk',
      'network.profile.unknown': 'Profil',
      'network.profile.loading': 'Laster…',
      'network.profile.loading_subtitle': 'Forbereder profil…',
      'network.profile.suspended_title': 'Profilen er utilgjengelig',
      'network.profile.suspended_subtitle': 'Denne profilen er for øyeblikket utilgjengelig.',
      'network.profile.not_found_title': 'Profilen ble ikke funnet',
      'network.profile.not_found_subtitle': 'Gå tilbake til Nettverk-katalogen for å velge en profil.',
      'network.profile.contact': 'Kontakt',
      'network.profile.quick_facts': 'Hurtigfakta',
      'network.profile.location': 'Sted',
      'network.profile.languages': 'Språk',
      'network.profile.ref': 'Referanse',
      'network.profile.source_ref': 'Kildereferanse',
      'network.profile.source_ref_btn': 'Vis',
      'network.profile.source_ref_loading': 'Laster…',
      'network.profile.source_ref_copy': 'Kopier',
      'network.profile.source_ref_copied': 'Kopiert',
      'network.profile.source_ref_not_found': 'Ikke funnet',
      'network.profile.source_ref_table_missing': 'Mangler tabell',
      'network.profile.source_ref_admin_only': 'Kun admin',
      'network.profile.source_ref_failed': 'Mislyktes',
      'network.profile.source_refs': 'Kildereferanser',
      'network.profile.about': 'Om',
      'network.profile.no_bio': 'Ingen beskrivelse ennå.',
      'network.profile.relationships': 'Relasjoner',
      'network.profile.agent_of_agency': 'Byrå',
      'network.profile.agent_of_developer': 'Utvikler',
      'network.profile.development_developer': 'Utvikler',
      'network.profile.agency_agents': 'Agenter i dette byrået',
      'network.profile.developer_developments': 'Prosjekter',
      'network.profile.developer_agents': 'Utviklerens agenter',
      'network.profile.no_relationships': 'Ingen relasjoner definert ennå.',
      'network.footer.p': 'Lokalt nettverk for Costa Blanca South: byråer, agenter, utviklere og verifiserte samarbeidspartnere.',
      'role.admin': 'Admin',
      'role.partner': 'Partner',
      'role.agency_admin': 'Byråadmin',
      'role.agent': 'Agent',
      'role.developer': 'Utvikler',
      'role.collaborator': 'Samarbeidspartner',
      'role.client': 'Klient',
      'ui.menu': 'Meny',
      'ui.map': 'Kart',
      'ui.list': 'Liste',
      'ui.open_filters': 'Åpne filtre',
      'ui.toggle_map': 'Veksle kart',
      'ui.clear_all_filters': 'Fjern alle filtre',
      'ui.apply_filters': 'Bruk filtre',
      'ui.close_filters': 'Lukk filtre',
      'pricing.on_request': 'Pris på forespørsel',

      'home.hero.title': 'Eiendom, bedrift og kjøretøy, håndtert som en concierge.',
      'home.hero.subtitle': 'Kjøp, selg, lei, administrer og vedlikehold. Ett pålitelig team for bruktboliger, nybygg, næringseiendommer, bedrifter til salgs og kjøretøy.',
      'home.hero.browse_properties': 'Se eiendommer',
      'home.hero.new_builds': 'Nybygg',
      'home.hero.businesses_for_sale': 'Bedrifter til salgs',
      'home.hero.vehicles': 'Kjøretøy',
      'home.hero.viewing_trip': 'Visningsreisepakke',
      'home.hero.viewing_privileges': 'Signature Viewing Privileges',
      'home.cards.properties.title': 'Eiendommer',
      'home.cards.properties.desc': 'Bruktboliger og nybyggprosjekter, pluss næringseiendommer, med lokal kartpresisjon.',
      'home.cards.businesses.title': 'Bedrifter',
      'home.cards.businesses.desc': 'Kjøp og selg bedrifter, pluss praktisk ledelse og dokumentasjonsstøtte.',
      'home.cards.vehicles.title': 'Kjøretøy',
      'home.cards.vehicles.desc': 'Biler og båter, til salgs eller leie, med praktisk støtte fra start til slutt.',
      'home.footer.title': 'Trenger du hjelp til å velge?',
      'home.footer.subtitle': 'Send oss det du leter etter (brukt eller nybygg), så lager vi en kort-liste raskt.',
      'home.footer.viewing_trip': 'Planlegg en visningsreise',
      'home.footer.viewing_privileges': 'Viewing Privileges (mar–apr)',
      ...
      'filters.search': 'Søk',
      'filters.ref': 'Ref',
      'filters.location': 'Sted',
      'filters.location_placeholder': 'Søk steder',
      'filters.any': 'Alle',
      'filters.type': 'Type',
      'filters.any_type': 'Alle typer',
      'filters.any_provider': 'Alle leverandører',
      'filters.operation': 'Operasjon',
      'filters.sale': 'Salg',
      'filters.rent_long': 'Langtidsleie',
      'filters.rent_vacation': 'Ferieleie',
      'filters.max_price': 'Maks pris',
      'filters.max_price_placeholder': 'Alle (f.eks. 50000)',
      'filters.beds': 'Soverom',
      'filters.baths': 'Bad',
      'filters.pool': 'Basseng',
      'filters.parking': 'Parkering',
      'filters.with_pool': 'Med basseng',
      'filters.private_pool': 'Privat basseng',
      'filters.communal_pool': 'Felles basseng',
      'filters.with_parking': 'Med parkering',
      'filters.beach': 'Strand',
      'filters.sea_view': 'Havutsikt',
      'filters.sea_view_yes': 'Havutsikt',

      'properties.results.found_prefix': 'Fant',
      'properties.results.found_suffix': 'annonser i Costa Blanca South',
      'properties.results.subtitle': 'Filtrer brukt- og nybyggannonser og bytt til kartvisning for å se nøyaktige resultater.',
      'properties.sort.label': 'Sorter',
      'properties.sort.featured': 'Utvalgte',
      'properties.sort.date_desc': 'Dato lagt til (nyeste)',
      'properties.sort.date_asc': 'Dato lagt til (eldste)',
      'properties.sort.price_asc': 'Pris (lav til høy)',
      'properties.sort.price_desc': 'Pris (høy til lav)',
      'properties.sort.beds_desc': 'Soverom (høy til lav)',
      'properties.sort.area_desc': 'Areal (høy til lav)',
      'properties.sort.eur_sqm_asc': '€/m2 (lav til høy)',
      'properties.sort.beach_asc': 'Strandavstand (nær til fjern)',
      'properties.saved': 'Lagrede',
      'properties.showing': 'Viser',
      'properties.send_saved': 'Opprett katalog',
      'properties.save_alert': 'Lagre varsling',
      'properties.cta.sell_property': 'Selg din eiendom',
      'properties.cta.new_builds': 'Nybygg',
      'properties.cta.viewing_trip': 'Planlegg en visningsreise (2–7 dager)',

      'listing.for_rent': 'Til leie',
      'listing.for_sale': 'Til salgs',
      'listing.traspaso': 'Traspaso',
      'listing.rent_short': 'Leie',
      'listing.business_for_sale': 'Bedrift til salgs',
      'listing.business': 'Bedrift',
      'listing.vehicle': 'Kjøretøy',
      'listing.save_aria': 'Lagre annonse',
      'listing.load_more': 'Last inn flere ({shown} / {total})',
      'listing.play_reel': 'Spill reel',

      'modal.type_default': 'Eiendom',
      'modal.town_unknown': 'Ukjent område',
      'modal.description_placeholder': 'Eiendomsdetaljer kommer snart.',
      'modal.location_title': 'Sted',
      'modal.open_google_maps': 'Åpne i Google Maps',
      'modal.amenities_title': 'Premium fasiliteter',
      'modal.fav_save': '♡ Lagre',
      'modal.fav_saved': '♥ Lagret',
      'modal.brochure_pdf': 'Brosjyre (PDF)',
      'modal.reel_play': 'Spill reel',
      'modal.share_video': 'Del video',
      'modal.reel_video': 'Reel Studio',
      'modal.tour_3d': '3D-omvisning',
      'modal.call_now': 'Ring nå',
      'modal.request_visit': 'Be om visning',
      'modal.share': 'Del',
      'modal.share.copy_link': 'Kopier lenke',
      'modal.share.copy_caption': 'Kopier bildetekst',
      ...
      'catalog.builder.source_filtered': 'Gjeldende søkeresultater',
      'catalog.builder.source_saved': 'Lagrede annonser',
      'catalog.builder.whitelabel': 'White-label',
      'catalog.builder.open': 'Åpne katalog',
      'catalog.builder.copy': 'Kopier lenke',

      'blog.hero.title': 'Blogg og markedspuls',
      'blog.hero.subtitle': 'Korte, nyttige oppdateringer generert fra offentlige overskrifter og Google Trends, med praktiske tips for Costa Blanca South.',
      'blog.tag.updated_daily': 'Oppdatert daglig',
      'blog.lang.auto': 'Mitt språk',
      'blog.filters.search_placeholder': 'Søk temaer…',
      'blog.actions.saved_filter': 'Lagrede',

      'brochure.print_pdf': 'Skriv ut / Lagre som PDF',
      'brochure.share_whatsapp': 'Send via WhatsApp',
      'brochure.back': 'Tilbake',
      'brochure.loading': 'Laster…',
      'brochure.white_label': 'White-label',
      'brochure.copy_link': 'Kopier lenke',
      'brochure.email_link': 'E-postlenke',
      'brochure.section.highlights': 'Høydepunkter',
      'brochure.section.description': 'Beskrivelse',
      'brochure.section.features': 'Egenskaper',
      'brochure.section.gallery': 'Galleri',

      'reel.back': 'Tilbake',
      'reel.loading': 'Laster…',
      'reel.white_label': 'White-label',
      'reel.play_video': 'Spill video',
      'reel.create_video': 'Lag video',
      'reel.share': 'Del',
      'reel.share_video': 'Del video',
      'reel.download': 'Last ned',
      'reel.copy_caption': 'Kopier bildetekst',
      'reel.auto_mode_note': 'Vi bygger automatisk den beste korte reelen fra annonsens medier og nøkkeldetaljer.',
      'reel.caption.label': 'Bildetekst',
      'reel.caption.price_label': 'Pris',
      'reel.caption.ref_label': 'Ref',
      'reel.caption.whatsapp_available': 'WhatsApp tilgjengelig',
      'reel.spec.bed': 'soverom',
      'reel.spec.beds': 'soverom',
      'reel.spec.bath': 'bad',
      'reel.spec.baths': 'bad',
      'reel.type.business': 'Bedrift',
      'reel.feature.sector_prefix': 'Sektor',
      'reel.feature.deal_traspaso': 'Type: Traspaso',
      'reel.feature.deal_business': 'Type: Bedrift til salgs',
      'reel.controls.duration': 'Varighet',
      'reel.controls.audio': 'Lyd',
      'reel.controls.overlay_caption': 'Vis tekst på videoen',
      'reel.duration.quick': '7s (Rask)',
      'reel.duration.recommended': '9s (Anbefalt)',
      'reel.duration.standard': '12s',
      'reel.duration.detailed': '15s (Detaljert)',
      'reel.audio.none': 'Ingen musikk',
      'reel.audio.ambient': 'Ambient',
      'reel.audio.upbeat': 'Oppstemt',
      'reel.audio.chill': 'Chill',
      'reel.audio.cinematic': 'Filmatisk',
      'reel.audio.tropical': 'Tropisk',
      'reel.audio.house': 'House',
      'reel.audio.lofi': 'Lo-fi',
      'reel.audio.piano': 'Piano',
      'reel.audio.sunset': 'Solnedgang',
      'reel.audio.corporate': 'Corporate',
      'reel.status.audio_fallback': 'Lydeksport støttes ikke her. Prøver igjen uten musikk.',
      'reel.status.auto_generating': 'Lager din reel…',
      'reel.status.choose_platform': 'Velg en plattform nedenfor.',
      'reel.status.no_video': 'Trykk på Spill video først.',
      'reel.status.preferred_app': 'Tips: trykk på Del video og velg {app}.',

      'map.tools.aria': 'Kartsøkverktøy',
      'map.tools.draw': 'Tegn område',
      'map.tools.around': 'Rundt meg',
      'map.tools.clear': 'Fjern',
      'map.tools.radius': 'Radius',

      'account.signin.title': 'Logg inn',
      'account.signin.button': 'Logg inn',
      'account.hero.subtitle': 'Logg inn for å synkronisere favoritter mellom enheter og låse opp partnerverktøy.',
      'account.profile.edit': 'Rediger profil',
      'account.profile.close': 'Lukk',
      'account.profile.display_name': 'Visningsnavn',
      'account.profile.save': 'Lagre',
      'account.dashboard.saved': 'Lagrede',

      'city.all': 'Alle områder',
      'city.torrevieja': 'Torrevieja',
      'city.orihuela_costa': 'Orihuela Costa',
      'city.guardamar': 'Guardamar',
      'city.quesada': 'Quesada',
      ...
      'vehicles.category.car': 'Bil',
      'vehicles.category.boat': 'Båt',
      'vehicles.deal.rent': 'Til leie',
      'vehicles.deal.sale': 'Til salgs',
      'vehicles.empty.title': 'Ingen kjøretøy funnet',
      'vehicles.actions.share': 'Del',

      'shop.actions.details': 'Detaljer',
      'shop.actions.open_in_shop': 'Åpne i butikk',
      'shop.price_on_request': 'Pris på forespørsel',
      'shop.no_description': 'Ingen beskrivelse tilgjengelig.',

      'tour.back': 'Tilbake',
      'tour.loading': 'Laster…',
      'tour.open_brochure': 'Brosjyre',
      'tour.share': 'Del',
      'tour.open_studio': 'Tour Studio',
      'tour.close_studio': 'Lukk Studio',
      'tour.title': 'Virtuell omvisning',
      'tour.overlay.title': 'Forbereder 3D-omvisning…',
      'tour.overlay.subtitle': 'Laster panorama og interaktive hotspots.',
      'tour.prev_scene': 'Forrige scene',
      'tour.next_scene': 'Neste scene',
      'tour.dollhouse.title': 'Dollhouse',
      'tour.scene_list': 'Scener',
      'tour.studio.title': 'Tour Studio (Insta360)',
      'tour.studio.badge': 'Adminverktøy',
      'tour.studio.note': 'Tips: for full 360-kvalitet, bruk 2:1 panoramabilder (JPG) fra Insta360-eksport.',

      'services.hero.title': 'Tjenester som reduserer friksjon',
      'page.collaborate.cta.email': 'Send e-post',
      'page.collaborate.cta.see_services': 'Se tjenester',
      'page.collaborate.cta.open_scout': 'Åpne Street Scout',
      'page.collaborate.cta.account': 'Logg inn / Opprett konto'
    },
    da: {
      'lang.label': 'Sprog',
      'lang.en': 'Engelsk',
      ...
      'common.all': 'Alle',
      'common.na': 'N/A',
      'common.price_on_request': 'Pris på forespørgsel',
      'common.per_night': 'nat',
      'common.per_day': 'dag',
      'common.per_week': 'uge',
      'common.per_month': 'måned',
      'common.copy': 'Kopiér',
      'common.open': 'Åbn',
      'common.back_to_account': 'Tilbage til konto',
      'common.refresh': 'Opdater',
      'common.export_csv': 'Eksportér CSV',
      'common.save': 'Gem',
      'common.saving': 'Gemmer…',
      'common.saved': 'Gemt.',
      'common.save_failed': 'Gemning mislykkedes',
      'nav.home': 'Hjem',
      'nav.properties': 'Ejendomme',
      'nav.new_builds': 'Nybyggeri',
      'nav.businesses': 'Virksomheder',
      'nav.vehicles': 'Køretøjer',
      'nav.services': 'Tjenester',
      'nav.blog': 'Blog',
      'nav.network': 'Netværk',
      'nav.account': 'Konto',
      'nav.contact_us': 'Kontakt os',
      'nav.email': 'E-mail',
      'nav.call': 'Ring',
      ...
      'network.hero.title': 'Netværk',
      'network.hero.subtitle': 'Bureauer, agenter, udviklere, projekter og verificerede samarbejdspartnere på Costa Blanca South.',
      'network.cta.join': 'Ansøg om at deltage',
      'network.cta.services': 'Se tjenester',
      'network.cta.whatsapp': 'WhatsApp',
      'network.cta.website': 'Hjemmeside',
      'network.filters.search': 'Søg',
      'network.filters.search_placeholder': 'Søg profiler…',
      'network.filters.type': 'Type',
      'network.kind.agencies': 'Bureauer',
      'network.kind.agents': 'Agenter',
      'network.kind.developers': 'Udviklere',
      'network.kind.developments': 'Projekter',
      'network.kind.collaborators': 'Samarbejdspartnere',
      'network.kind.agency': 'Bureau',
      'network.kind.agent': 'Agent',
      'network.kind.developer': 'Udvikler',
      'network.kind.development': 'Projekt',
      'network.kind.collaborator': 'Samarbejdspartner',
      'network.verified': 'Verificeret',
      'network.suspended': 'Suspenderet',
      'network.suspended_reason_unknown': 'Ingen grund angivet.',
      'network.count': '{n} profiler',
      'network.empty.title': 'Ingen profiler endnu',
      'network.empty.subtitle': 'Tilføj profiler i network-data.js.',
      'network.card.open_hint': 'Tryk på kortet for at åbne profilen',
      'network.card.open_aria': 'Åbn profil: {name}',
      'network.profile.back': '← Tilbage til Netværk',
      'network.profile.unknown': 'Profil',
      'network.profile.loading': 'Indlæser…',
      'network.profile.loading_subtitle': 'Forbereder profil…',
      'network.profile.suspended_title': 'Profilen er utilgængelig',
      'network.profile.suspended_subtitle': 'Denne profil er i øjeblikket utilgængelig.',
      'network.profile.not_found_title': 'Profilen blev ikke fundet',
      'network.profile.not_found_subtitle': 'Gå tilbage til Netværk-kataloget for at vælge en profil.',
      'network.profile.contact': 'Kontakt',
      'network.profile.quick_facts': 'Hurtige fakta',
      'network.profile.location': 'Beliggenhed',
      'network.profile.languages': 'Sprog',
      'network.profile.ref': 'Reference',
      'network.profile.source_ref': 'Kildereference',
      'network.profile.source_ref_btn': 'Vis',
      'network.profile.source_ref_loading': 'Indlæser…',
      'network.profile.source_ref_copy': 'Kopiér',
      'network.profile.source_ref_copied': 'Kopieret',
      'network.profile.source_ref_not_found': 'Ikke fundet',
      'network.profile.source_ref_table_missing': 'Mangler tabel',
      'network.profile.source_ref_admin_only': 'Kun admin',
      'network.profile.source_ref_failed': 'Mislykkedes',
      'network.profile.source_refs': 'Kildereferencer',
      'network.profile.about': 'Om',
      'network.profile.no_bio': 'Ingen beskrivelse endnu.',
      'network.profile.relationships': 'Relationer',
      'network.profile.agent_of_agency': 'Bureau',
      'network.profile.agent_of_developer': 'Udvikler',
      'network.profile.development_developer': 'Udvikler',
      'network.profile.agency_agents': 'Agenter i dette bureau',
      'network.profile.developer_developments': 'Projekter',
      'network.profile.developer_agents': 'Udviklerens agenter',
      'network.profile.no_relationships': 'Ingen relationer defineret endnu.',
      'network.footer.p': 'Lokalt netværk for Costa Blanca South: bureauer, agenter, udviklere og verificerede samarbejdspartnere.',
      'role.admin': 'Admin',
      'role.partner': 'Partner',
      'role.agency_admin': 'Bureauadmin',
      'role.agent': 'Agent',
      'role.developer': 'Udvikler',
      'role.collaborator': 'Samarbejdspartner',
      'role.client': 'Klient',
      'ui.menu': 'Menu',
      'ui.map': 'Kort',
      'ui.list': 'Liste',
      'ui.open_filters': 'Åbn filtre',
      'ui.toggle_map': 'Skift kort',
      'ui.clear_all_filters': 'Fjern alle filtre',
      'ui.apply_filters': 'Anvend filtre',
      'ui.close_filters': 'Luk filtre',
      'pricing.on_request': 'Pris på forespørgsel',

      'home.hero.title': 'Ejendom, virksomhed og køretøj, håndteret som en concierge.',
      'home.hero.subtitle': 'Køb, sælg, lej, administrér og vedligehold. Ét betroet team for brugte boliger, nybyggerier, erhvervsejendomme, virksomheder til salg og køretøjer.',
      'home.hero.browse_properties': 'Se ejendomme',
      'home.hero.new_builds': 'Nybyggeri',
      'home.hero.businesses_for_sale': 'Virksomheder til salg',
      'home.hero.vehicles': 'Køretøjer',
      'home.hero.viewing_trip': 'Fremvisningsrejsepakke',
      'home.hero.viewing_privileges': 'Signature Viewing Privileges',
      'home.cards.properties.title': 'Ejendomme',
      'home.cards.properties.desc': 'Brugte boliger og nybyggerier, plus erhvervsejendomme, med lokal kortpræcision.',
      'home.cards.businesses.title': 'Virksomheder',
      'home.cards.businesses.desc': 'Køb og sælg virksomheder, plus praktisk ledelse og dokumentationsstøtte.',
      'home.cards.vehicles.title': 'Køretøjer',
      'home.cards.vehicles.desc': 'Biler og både, til salg eller leje, med praktisk støtte fra start til slut.',
      'home.footer.title': 'Brug for hjælp til at vælge?',
      'home.footer.subtitle': 'Send os hvad du leder efter (brugt eller nybyg), så laver vi en kort-liste hurtigt.',
      'home.footer.viewing_trip': 'Planlæg en fremvisningsrejse',
      'home.footer.viewing_privileges': 'Viewing Privileges (mar–apr)',
      ...
      'filters.search': 'Søg',
      'filters.ref': 'Ref',
      'filters.location': 'Beliggenhed',
      'filters.location_placeholder': 'Søg beliggenheder',
      'filters.any': 'Alle',
      'filters.type': 'Type',
      'filters.any_type': 'Alle typer',
      'filters.any_provider': 'Alle udbydere',
      'filters.operation': 'Handling',
      'filters.sale': 'Salg',
      'filters.rent_long': 'Langtidsleje',
      'filters.rent_vacation': 'Ferieleje',
      'filters.max_price': 'Maks pris',
      'filters.max_price_placeholder': 'Alle (f.eks. 50000)',
      'filters.beds': 'Soveværelser',
      'filters.baths': 'Badeværelser',
      'filters.pool': 'Pool',
      'filters.parking': 'Parkering',
      'filters.with_pool': 'Med pool',
      'filters.private_pool': 'Privat pool',
      'filters.communal_pool': 'Fælles pool',
      'filters.with_parking': 'Med parkering',
      'filters.beach': 'Strand',
      'filters.sea_view': 'Havudsigt',
      'filters.sea_view_yes': 'Havudsigt',

      'properties.results.found_prefix': 'Fandt',
      'properties.results.found_suffix': 'annoncer i Costa Blanca South',
      'properties.results.subtitle': 'Filtrér brugt- og nybyggeriannoncer og skift til kortvisning for at se nøjagtige resultater.',
      'properties.sort.label': 'Sortér',
      'properties.sort.featured': 'Udvalgte',
      'properties.sort.date_desc': 'Dato tilføjet (nyeste)',
      'properties.sort.date_asc': 'Dato tilføjet (ældste)',
      'properties.sort.price_asc': 'Pris (lav til høj)',
      'properties.sort.price_desc': 'Pris (høj til lav)',
      'properties.sort.beds_desc': 'Soveværelser (høj til lav)',
      'properties.sort.area_desc': 'Areal (høj til lav)',
      'properties.sort.eur_sqm_asc': '€/m2 (lav til høj)',
      'properties.sort.beach_asc': 'Strandafstand (nær til fjern)',
      'properties.saved': 'Gemte',
      'properties.showing': 'Viser',
      'properties.send_saved': 'Opret katalog',
      'properties.save_alert': 'Gem besked',
      'properties.cta.sell_property': 'Sælg din ejendom',
      'properties.cta.new_builds': 'Nybyggeri',
      'properties.cta.viewing_trip': 'Planlæg en fremvisningsrejse (2–7 dage)',

      'listing.for_rent': 'Til leje',
      'listing.for_sale': 'Til salg',
      'listing.traspaso': 'Traspaso',
      'listing.rent_short': 'Leje',
      'listing.business_for_sale': 'Virksomhed til salg',
      'listing.business': 'Virksomhed',
      'listing.vehicle': 'Køretøj',
      'listing.save_aria': 'Gem annonce',
      'listing.load_more': 'Indlæs flere ({shown} / {total})',
      'listing.play_reel': 'Afspil reel',

      'modal.type_default': 'Ejendom',
      'modal.town_unknown': 'Ukendt område',
      'modal.description_placeholder': 'Ejendomsdetaljer kommer snart.',
      'modal.location_title': 'Beliggenhed',
      'modal.open_google_maps': 'Åbn i Google Maps',
      'modal.amenities_title': 'Premium faciliteter',
      'modal.fav_save': '♡ Gem',
      'modal.fav_saved': '♥ Gemt',
      'modal.brochure_pdf': 'Brochure (PDF)',
      'modal.reel_play': 'Afspil reel',
      'modal.share_video': 'Del video',
      'modal.reel_video': 'Reel Studio',
      'modal.tour_3d': '3D-rundvisning',
      'modal.call_now': 'Ring nu',
      'modal.request_visit': 'Anmod om fremvisning',
      'modal.share': 'Del',
      'modal.share.copy_link': 'Kopiér link',
      'modal.share.copy_caption': 'Kopiér billedtekst',
      ...
      'catalog.builder.source_filtered': 'Aktuelle søgeresultater',
      'catalog.builder.source_saved': 'Gemte annoncer',
      'catalog.builder.whitelabel': 'White-label',
      'catalog.builder.open': 'Åbn katalog',
      'catalog.builder.copy': 'Kopiér link',

      'blog.hero.title': 'Blog og markedspuls',
      'blog.hero.subtitle': 'Korte, nyttige opdateringer genereret fra offentlige overskrifter og Google Trends, med praktiske tips til Costa Blanca South.',
      'blog.tag.updated_daily': 'Opdateret dagligt',
      'blog.lang.auto': 'Mit sprog',
      'blog.filters.search_placeholder': 'Søg emner…',
      'blog.actions.saved_filter': 'Gemte',

      'brochure.print_pdf': 'Udskriv / Gem som PDF',
      'brochure.share_whatsapp': 'Send via WhatsApp',
      'brochure.back': 'Tilbage',
      'brochure.loading': 'Indlæser…',
      'brochure.white_label': 'White-label',
      'brochure.copy_link': 'Kopiér link',
      'brochure.email_link': 'E-mail-link',
      'brochure.section.highlights': 'Højdepunkter',
      'brochure.section.description': 'Beskrivelse',
      'brochure.section.features': 'Egenskaber',
      'brochure.section.gallery': 'Galleri',

      'reel.back': 'Tilbage',
      'reel.loading': 'Indlæser…',
      'reel.white_label': 'White-label',
      'reel.play_video': 'Afspil video',
      'reel.create_video': 'Opret video',
      'reel.share': 'Del',
      'reel.share_video': 'Del video',
      'reel.download': 'Download',
      'reel.copy_caption': 'Kopiér billedtekst',
      'reel.auto_mode_note': 'Vi bygger automatisk den bedste korte reel fra annoncens medier og nøgledetaljer.',
      'reel.caption.label': 'Billedtekst',
      'reel.caption.price_label': 'Pris',
      'reel.caption.ref_label': 'Ref',
      'reel.caption.whatsapp_available': 'WhatsApp tilgængelig',
      'reel.spec.bed': 'soveværelse',
      'reel.spec.beds': 'soveværelser',
      'reel.spec.bath': 'badeværelse',
      'reel.spec.baths': 'badeværelser',
      'reel.type.business': 'Virksomhed',
      'reel.feature.sector_prefix': 'Sektor',
      'reel.feature.deal_traspaso': 'Type: Traspaso',
      'reel.feature.deal_business': 'Type: Virksomhed til salg',
      'reel.controls.duration': 'Varighed',
      'reel.controls.audio': 'Lyd',
      'reel.controls.overlay_caption': 'Vis tekst på videoen',
      'reel.duration.quick': '7s (Hurtig)',
      'reel.duration.recommended': '9s (Anbefalet)',
      'reel.duration.standard': '12s',
      'reel.duration.detailed': '15s (Detaljeret)',
      'reel.audio.none': 'Ingen musik',
      'reel.audio.ambient': 'Ambient',
      'reel.audio.upbeat': 'Opstemt',
      'reel.audio.chill': 'Chill',
      'reel.audio.cinematic': 'Filmisk',
      'reel.audio.tropical': 'Tropisk',
      'reel.audio.house': 'House',
      'reel.audio.lofi': 'Lo-fi',
      'reel.audio.piano': 'Piano',
      'reel.audio.sunset': 'Solnedgang',
      'reel.audio.corporate': 'Corporate',
      'reel.status.audio_fallback': 'Lydeksport understøttes ikke her. Prøver igen uden musik.',
      'reel.status.auto_generating': 'Opretter din reel…',
      'reel.status.choose_platform': 'Vælg en platform nedenfor.',
      'reel.status.no_video': 'Tryk på Afspil video først.',
      'reel.status.preferred_app': 'Tip: tryk på Del video og vælg {app}.',

      'map.tools.aria': 'Kortsøgeværktøjer',
      'map.tools.draw': 'Tegn område',
      'map.tools.around': 'Omkring mig',
      'map.tools.clear': 'Fjern',
      'map.tools.radius': 'Radius',

      'account.signin.title': 'Log ind',
      'account.signin.button': 'Log ind',
      'account.hero.subtitle': 'Log ind for at synkronisere favoritter mellem enheder og låse op for partnerværktøjer.',
      'account.profile.edit': 'Redigér profil',
      'account.profile.close': 'Luk',
      'account.profile.display_name': 'Visningsnavn',
      'account.profile.save': 'Gem',
      'account.dashboard.saved': 'Gemte',
      ...
      'vehicles.category.car': 'Bil',
      'vehicles.category.boat': 'Båd',
      'vehicles.deal.rent': 'Til leje',
      'vehicles.deal.sale': 'Til salg',
      'vehicles.empty.title': 'Ingen køretøjer fundet',
      'vehicles.actions.share': 'Del',

      'shop.actions.details': 'Detaljer',
      'shop.actions.open_in_shop': 'Åbn i butik',
      'shop.price_on_request': 'Pris på forespørgsel',
      'shop.no_description': 'Ingen beskrivelse tilgængelig.',

      'tour.back': 'Tilbage',
      'tour.loading': 'Indlæser…',
      'tour.open_brochure': 'Brochure',
      'tour.share': 'Del',
      'tour.open_studio': 'Tour Studio',
      'tour.close_studio': 'Luk Studio',
      'tour.title': 'Virtuel rundvisning',
      'tour.overlay.title': 'Forbereder 3D-rundvisning…',
      'tour.overlay.subtitle': 'Indlæser panorama og interaktive hotspots.',
      'tour.prev_scene': 'Forrige scene',
      'tour.next_scene': 'Næste scene',
      'tour.dollhouse.title': 'Dollhouse',
      'tour.scene_list': 'Scener',
      'tour.studio.title': 'Tour Studio (Insta360)',
      'tour.studio.badge': 'Adminværktøj',
      'tour.studio.note': 'Tip: for fuld 360-kvalitet, brug 2:1 panoramabilleder (JPG) fra Insta360-eksport.',

      'services.hero.title': 'Tjenester der reducerer friktion',
      'page.collaborate.cta.email': 'Send e-mail',
      'page.collaborate.cta.see_services': 'Se tjenester',
      'page.collaborate.cta.open_scout': 'Åbn Street Scout',
      'page.collaborate.cta.account': 'Log ind / Opret konto'
    },
    de: {
      'lang.label': 'Sprache',
      'lang.en': 'Englisch',
      ...
      'affiliate.links.viewing_privileges': 'Viewing Privileges (Kampagne)',
      'affiliate.links.viewing_privileges_note': 'Tipp: Affiliates können die Sprache des Käufers hinzufügen, z.B. <span class=\"muted\" style=\"font-weight:900;\">?lang=de</span>, <span class=\"muted\" style=\"font-weight:900;\">?lang=nl</span> oder <span class=\"muted\" style=\"font-weight:900;\">?lang=fr</span>.',

      'home.hero.viewing_privileges': 'Signature Viewing Privileges',
      'home.footer.viewing_privileges': 'Viewing Privileges (März–April)',

      'page.viewing_trip.privileges.title': 'Signature Viewing Privileges (1. März – 30. April 2026)',
      'page.viewing_trip.privileges.p': 'Sichern Sie sich im Aktionszeitraum eine qualifizierende Immobilie und erhalten Sie bei Abschluss eine Gutschrift für Ihre Besichtigungsreise. Bei Neubauten gibt es zusätzlich eine Return-Stay-Gutschrift. Bedingungen gelten.',
      'page.viewing_trip.privileges.cta': 'Zum Angebot',
      'page.viewing_trip.privileges.terms': 'Bedingungen',

      'page.viewing_privileges.hero.title': 'Signature Viewing Privileges',
      'page.viewing_privileges.hero.p': 'Ein zeitlich begrenztes Private-Client-Angebot für ernsthafte Käufer. Sichern Sie sich eine qualifizierende Immobilie im Aktionszeitraum und erhalten Sie bei Abschluss eine Gutschrift für Ihre Besichtigungsreise. Bei Neubauten gibt es zusätzlich eine Return-Stay-Gutschrift.',
      'page.viewing_privileges.tag.window': '1. März – 30. April 2026',
      'page.viewing_privileges.tag.completion': 'Auszahlung bei Abschluss',
      'page.viewing_privileges.tag.caps': 'Belegbasierte Limits',
      'page.viewing_privileges.tag.newbuilds_resales': 'Neubau + Bestand',
      'page.viewing_privileges.cta.book_email': 'Per E-Mail buchen',
      'page.viewing_privileges.cta.browse_new_builds': 'Neubauten ansehen',
      'page.viewing_privileges.cta.browse_resales': 'Bestand ansehen',
      'page.viewing_privileges.cta.terms': 'Bedingungen',
      'page.viewing_privileges.hero.note': 'Teilnahmeberechtigung setzt einen verbindlichen Reservierungs-/privaten Kaufvertrag voraus, der im Aktionszeitraum unterzeichnet wurde. Gutschriften werden bei Abschluss ausgezahlt. Begrenzte Verfügbarkeit. Bedingungen gelten.',
      'page.viewing_privileges.section.newbuilds.title': 'Neubau-Vorteile',
      'page.viewing_privileges.section.newbuilds.p': 'Neubau-Käufer erhalten zwei Completion-Gutschriften: eine Besichtigungsreise-Gutschrift und eine Return-Stay-Gutschrift. Die Obergrenzen richten sich nach dem Kaufpreis, damit alles proportional zum Budget bleibt. Die Return-Stay-Gutschrift kann für einen zweiten Besuch hier oder als Reiseguthaben an einem anderen Ort genutzt werden.',
      'page.viewing_privileges.tier.1.title': '€250k – €399k',
      'page.viewing_privileges.tier.1.p': 'Besichtigungsreise-Gutschrift bis zu €1.500 + Return-Stay-Gutschrift bis zu €750.',
      'page.viewing_privileges.tier.2.title': '€400k – €699k',
      'page.viewing_privileges.tier.2.p': 'Besichtigungsreise-Gutschrift bis zu €2.500 + Return-Stay-Gutschrift bis zu €1.000.',
      'page.viewing_privileges.tier.3.title': '€700k – €999k',
      'page.viewing_privileges.tier.3.p': 'Besichtigungsreise-Gutschrift bis zu €3.500 + Return-Stay-Gutschrift bis zu €1.250.',
      'page.viewing_privileges.tier.4.title': '€1,000,000+',
      'page.viewing_privileges.tier.4.p': 'Besichtigungsreise-Gutschrift bis zu €5.000 + Return-Stay-Gutschrift bis zu €1.500.',
      'page.viewing_privileges.section.newbuilds.note': 'Besichtigungsreise-Gutschrift ist belegbasiert und wird bei Abschluss ausgezahlt (nicht bei Reservierung). Return-Stay-Gutschrift wird bei Abschluss als Reiseguthaben/Voucher ausgegeben (keine Barauszahlung; gültig 12 Monate). Eine Käuferpartei pro Kauf.',
      'page.viewing_privileges.section.resales.title': 'Bestandsimmobilien-Vorteile',
      'page.viewing_privileges.section.resales.p': 'Für Bestandsimmobilien gibt es im März und April eine monatliche VIP-Gutschrift. Das schafft Dringlichkeit, ohne den Markt zu einer Rabattschlacht zu machen.',
      'page.viewing_privileges.resale.vip.title': 'Monatliche VIP-Besichtigungsreise-Gutschrift',
      'page.viewing_privileges.resale.vip.p': 'Im März 2026 und April 2026 erhält der erste Käufer einer Bestandsimmobilie, der einen verbindlichen privaten Kaufvertrag unterzeichnet, eine Besichtigungsreise-Gutschrift bis zu €1.500, ausgezahlt bei Abschluss.',
      'page.viewing_privileges.resale.concierge.title': 'Completion Concierge Pack',
      'page.viewing_privileges.resale.concierge.p': 'Alle Käufer von Bestandsimmobilien, die im Aktionszeitraum unterschreiben, erhalten strukturierten Support bis zum Abschluss: Timeline, Notar-Koordination und Übergabeplanung.',
      'page.viewing_privileges.section.resales.note': 'VIP-Auswahl basiert auf dem von Spanish Coast Properties erfassten Signaturzeitpunkt. Wenn der VIP-Käufer storniert oder nicht teilnahmeberechtigt ist, wird der nächste berechtigte Käufer in diesem Monat ausgewählt.',
      'page.viewing_privileges.section.how.title': 'So funktioniert es',
      'page.viewing_privileges.how.1.title': '1) Strukturierte Besichtigungsreise buchen',
      'page.viewing_privileges.how.1.p': 'Wir klären Budget und Must-haves und erstellen dann Shortlist und Itinerary, damit die Reise effizient bleibt.',
      'page.viewing_privileges.how.2.title': '2) Im Aktionszeitraum reservieren',
      'page.viewing_privileges.how.2.p': 'Zur Qualifikation müssen Sie zwischen dem 1. März und 30. April 2026 einen verbindlichen Reservierungs-/privaten Vertrag unterzeichnen.',
      'page.viewing_privileges.how.3.title': '3) Abschließen und Gutschriften erhalten',
      'page.viewing_privileges.how.3.p': 'Bei notarieller Beurkundung verarbeiten wir Ihre anrechenbaren Gutschriften (bis zu den Limits) anhand der Belege.',
      'page.viewing_privileges.section.terms.title': 'Wichtige Bedingungen (Kurzfassung)',
      'page.viewing_privileges.terms.1': 'Gutschriften werden nur bei Abschluss ausgezahlt (nicht bei Reservierung).',
      'page.viewing_privileges.terms.2': 'Besichtigungsreise-Gutschrift ist belegbasiert: Flüge, Unterkunft, Mietwagen und Transfers. Ausgeschlossen sind Mahlzeiten, Upgrades und Ausflüge ohne Besichtigung.',
      'page.viewing_privileges.terms.3': 'Return-Stay-Gutschrift wird bei Abschluss als Reiseguthaben/Voucher ausgegeben (keine Barauszahlung; gültig 12 Monate), für einen zweiten Besuch hier oder an einem anderen Ort. Eine Käuferpartei pro Kauf. Neubau: Limits nach Stufe. Bestand: monatliches VIP-Limit.',
      'page.viewing_privileges.terms.4': 'Aktionszeitraum: 1. März bis 30. April 2026 (CET/CEST). Abschluss kann danach erfolgen.',
      'page.viewing_privileges.terms.5': 'Begrenzte Verfügbarkeit und mögliches vorzeitiges Ende bei Erreichen der Kapazität. Bedingungen gelten.',
      'page.viewing_privileges.cta.read_full_terms': 'Vollständige Bedingungen lesen',
      'page.viewing_privileges.cta.viewing_trip_package': 'Besichtigungsreise-Paket',
      'page.viewing_privileges.footer.p': 'Private-Client-Besichtigungsreisen, die aus „Schauen“ eine sichere Kaufentscheidung machen.',

      'page.viewing_privileges_terms.hero.title': 'Signature Viewing Privileges Bedingungen',
      'page.viewing_privileges_terms.hero.p': 'Diese Bedingungen gelten für die Signature Viewing Privileges Kampagne von Spanish Coast Properties. Gutschriften werden nur bei Abschluss ausgezahlt.',
      'page.viewing_privileges_terms.tag.window': 'Aktionszeitraum: 1. März – 30. April 2026',
      'page.viewing_privileges_terms.tag.region': 'CET/CEST',
      'page.viewing_privileges_terms.tag.paid': 'Auszahlung bei Abschluss',
      'page.viewing_privileges_terms.hero.note': 'Falls Übersetzungen nur zur Vereinfachung angezeigt werden, gilt im Konfliktfall die englische Version als Referenz.',
      'page.viewing_privileges_terms.cta.back': 'Zurück zum Angebot',
      'page.viewing_privileges_terms.cta.email': 'Per E-Mail fragen',
      'page.viewing_privileges_terms.cta.book': 'Per E-Mail buchen',
      'page.viewing_privileges_terms.section.definitions.title': '1) Definitionen',
      'page.viewing_privileges_terms.def.1': '<strong>Käuferpartei</strong>: ein Haushalt / eine Gruppe, die gemeinsam die Immobilie kauft.',
      'page.viewing_privileges_terms.def.2': '<strong>Aktionszeitraum</strong>: vom 1. März 2026 bis 30. April 2026 (CET/CEST), einschließlich.',
      'page.viewing_privileges_terms.def.3': '<strong>Verbindlicher Vertrag</strong>: ein unterzeichneter Reservierungs-/privater Kaufvertrag, der gemäß den vereinbarten Bedingungen verbindlich ist, inklusive erforderlicher Anzahlungen.',
      'page.viewing_privileges_terms.def.4': '<strong>Abschluss</strong>: notarieller Abschluss (escritura) des qualifizierenden Kaufs.',
      'page.viewing_privileges_terms.def.5': '<strong>Gutschriften</strong>: Completion-Gutschriften, ausgezahlt bei Abschluss (nicht bei Reservierung), vorbehaltlich Limits und Belegen.',
      'page.viewing_privileges_terms.section.eligibility.title': '2) Teilnahme',
      'page.viewing_privileges_terms.elig.1': 'Zur Qualifikation muss die Käuferpartei im Aktionszeitraum einen verbindlichen Vertrag für eine qualifizierende Immobilie unterzeichnen.',
      'page.viewing_privileges_terms.elig.2': 'Gutschriften werden nur bei notarieller Beurkundung ausgezahlt. Erfolgt kein Abschluss, besteht kein Anspruch.',
      'page.viewing_privileges_terms.elig.3': 'Besichtigungen müssen über Spanish Coast Properties organisiert oder bestätigt sein, damit Ausgaben anrechenbar sind.',
      'page.viewing_privileges_terms.elig.4': 'Eine Gutschriften-Kombination pro Käuferpartei und Kauf. Gutschriften sind nicht übertragbar.',
      'page.viewing_privileges_terms.section.newbuilds.title': '3) Neubau-Gutschriften (gestaffelte Limits)',
      'page.viewing_privileges_terms.section.newbuilds.p': 'Neubau-Käufer können zwei Gutschriften erhalten: Besichtigungsreise-Gutschrift und Return-Stay-Gutschrift. Limits hängen vom Kaufpreis ab.',
      'page.viewing_privileges_terms.section.newbuilds.note': 'Besichtigungsreise-Gutschrift wird bei Abschluss gegen Belege erstattet (bis zu den Limits). Return-Stay-Gutschrift wird bei Abschluss als Reiseguthaben/Voucher ausgegeben (keine Barauszahlung), gültig für 12 Monate.',
      'page.viewing_privileges_terms.tier.1.title': '€250k – €399k',
      'page.viewing_privileges_terms.tier.1.p': 'Besichtigungsreise-Gutschrift bis zu €1.500 + Return-Stay-Gutschrift bis zu €750.',
      'page.viewing_privileges_terms.tier.2.title': '€400k – €699k',
      'page.viewing_privileges_terms.tier.2.p': 'Besichtigungsreise-Gutschrift bis zu €2.500 + Return-Stay-Gutschrift bis zu €1.000.',
      'page.viewing_privileges_terms.tier.3.title': '€700k – €999k',
      'page.viewing_privileges_terms.tier.3.p': 'Besichtigungsreise-Gutschrift bis zu €3.500 + Return-Stay-Gutschrift bis zu €1.250.',
      'page.viewing_privileges_terms.tier.4.title': '€1,000,000+',
      'page.viewing_privileges_terms.tier.4.p': 'Besichtigungsreise-Gutschrift bis zu €5.000 + Return-Stay-Gutschrift bis zu €1.500.',
      'page.viewing_privileges_terms.section.resales.title': '4) Bestandsimmobilien-Gutschriften (monatlicher VIP)',
      'page.viewing_privileges_terms.resale.1': 'Im März 2026 und April 2026 erhält der erste Käufer einer Bestandsimmobilie, der einen verbindlichen privaten Kaufvertrag unterzeichnet (Zeitstempel durch Spanish Coast Properties), eine Besichtigungsreise-Gutschrift bis zu €1.500, ausgezahlt bei Abschluss.',
      'page.viewing_privileges_terms.resale.2': 'Wenn der VIP-Käufer storniert, nicht teilnahmeberechtigt ist oder nicht abschließt, wird der nächste berechtigte Käufer in diesem Monat ausgewählt.',
      'page.viewing_privileges_terms.resale.3': 'Alle Käufer von Bestandsimmobilien, die im Aktionszeitraum unterschreiben, erhalten das Completion Concierge Pack (nicht-monetärer Support).',
      'page.viewing_privileges_terms.section.expenses.title': '5) Anrechenbare Kosten (Besichtigungsreise-Gutschrift)',
      'page.viewing_privileges_terms.section.expenses.p': 'Besichtigungsreise-Gutschrift ist belegbasiert und auf dokumentierte, anrechenbare Kosten bis zu den jeweiligen Limits beschränkt.',
      'page.viewing_privileges_terms.exp.1': '<strong>Inklusive</strong>: Flüge/Bahn, Unterkunft, Mietwagen, Flughafentransfers und lokale Transporte, die direkt mit der Besichtigungsreise zusammenhängen.',
      'page.viewing_privileges_terms.exp.2': '<strong>Exklusive</strong>: Mahlzeiten, Upgrades, Einkäufe, Unterhaltung, Ausflüge ohne Besichtigung sowie Kosten ohne Belege.',
      'page.viewing_privileges_terms.exp.3': 'Belege müssen auf den Käufer ausgestellt sein (oder klar der Käuferpartei zuordenbar) und auf Anfrage vorgelegt werden.',
      'page.viewing_privileges_terms.section.payment.title': '6) Auszahlung & Bearbeitung',
      'page.viewing_privileges_terms.pay.1': 'Gutschriften werden nur bei Abschluss ausgezahlt. Übliche Bearbeitung innerhalb von 10 Werktagen nach Abschluss und Belegprüfung.',
      'page.viewing_privileges_terms.pay.2': 'Auszahlung per Banküberweisung und/oder Verrechnung mit einer Rechnung von Spanish Coast Properties, nach unserem Ermessen.',
      'page.viewing_privileges_terms.pay.3': 'Belege in anderer Währung können zu einem angemessenen Referenzkurs in EUR umgerechnet werden.',
      'page.viewing_privileges_terms.section.general.title': '7) Allgemeines',
      'page.viewing_privileges_terms.gen.1': 'Dieses Angebot kann nicht gegen Bargeld über den Wert der belegten, anrechenbaren Kosten und die jeweiligen Limits hinaus eingetauscht werden.',
      'page.viewing_privileges_terms.gen.2': 'Das Angebot kann zurückgezogen oder vorzeitig beendet werden, wenn die Kapazität erreicht ist oder Missbrauch/Betrug vermutet wird.',
      'page.viewing_privileges_terms.gen.3': 'Spanish Coast Properties kann die Auszahlung verweigern, wenn die Bedingungen nicht erfüllt sind.',
      'page.viewing_privileges_terms.footer.p': 'Signature Viewing Privileges dienen dazu, die Due Diligence ernsthafter Käufer zu unterstützen.'
    },
    nl: {
      'lang.label': 'Taal',
      'lang.en': 'Engels',
      ...
      'affiliate.links.viewing_privileges': 'Viewing Privileges (campagne)',
      'affiliate.links.viewing_privileges_note': 'Tip: affiliates kunnen een taal voor de koper toevoegen, bijv. <span class=\"muted\" style=\"font-weight:900;\">?lang=de</span>, <span class=\"muted\" style=\"font-weight:900;\">?lang=nl</span> of <span class=\"muted\" style=\"font-weight:900;\">?lang=fr</span>.',

      'home.hero.viewing_privileges': 'Signature Viewing Privileges',
      'home.footer.viewing_privileges': 'Viewing Privileges (mrt–apr)',

      'page.viewing_trip.privileges.title': 'Signature Viewing Privileges (1 mrt – 30 apr 2026)',
      'page.viewing_trip.privileges.p': 'Reserveer een woning die in aanmerking komt binnen de campagneperiode en ontvang bij overdracht een credit voor je bezichtigingsreis. Nieuwbouw bevat een extra Return Stay-credit. Voorwaarden van toepassing.',
      'page.viewing_trip.privileges.cta': 'Bekijk de actie',
      'page.viewing_trip.privileges.terms': 'Voorwaarden',

      'page.viewing_privileges.hero.title': 'Signature Viewing Privileges',
      'page.viewing_privileges.hero.p': 'Een tijdelijke Private Client-aanbieding voor serieuze kopers. Reserveer een in aanmerking komende woning binnen de campagneperiode en ontvang bij overdracht completion-credits voor je bezichtigingsreis. Voor nieuwbouw is er een extra Return Stay-credit.',
      'page.viewing_privileges.tag.window': '1 mrt – 30 apr 2026',
      'page.viewing_privileges.tag.completion': 'Uitbetaald bij overdracht',
      'page.viewing_privileges.tag.caps': 'Maxima op basis van bonnen',
      'page.viewing_privileges.tag.newbuilds_resales': 'Nieuwbouw + bestaande bouw',
      'page.viewing_privileges.cta.book_email': 'Aanvragen via e-mail',
      'page.viewing_privileges.cta.browse_new_builds': 'Bekijk nieuwbouw',
      'page.viewing_privileges.cta.browse_resales': 'Bekijk bestaande bouw',
      'page.viewing_privileges.cta.terms': 'Voorwaarden',
      'page.viewing_privileges.hero.note': 'Geschiktheid is gebaseerd op een bindende reservering/koopovereenkomst die binnen de campagneperiode is ondertekend. Credits worden uitbetaald bij overdracht. Beperkte beschikbaarheid. Voorwaarden van toepassing.',
      'page.viewing_privileges.section.newbuilds.title': 'Nieuwbouw-voordelen',
      'page.viewing_privileges.section.newbuilds.p': 'Nieuwbouwkopers ontvangen twee completion-credits: een credit voor de bezichtigingsreis en een Return Stay-credit. De maxima zijn gekoppeld aan de koopsom, zodat het proportioneel blijft. De Return Stay-credit kan worden gebruikt voor een tweede bezoek hier, of als reistegoed elders.',
      'page.viewing_privileges.tier.1.title': '€250k – €399k',
      'page.viewing_privileges.tier.1.p': 'Credit bezichtigingsreis tot €1.500 + Return Stay-credit tot €750.',
      'page.viewing_privileges.tier.2.title': '€400k – €699k',
      'page.viewing_privileges.tier.2.p': 'Credit bezichtigingsreis tot €2.500 + Return Stay-credit tot €1.000.',
      'page.viewing_privileges.tier.3.title': '€700k – €999k',
      'page.viewing_privileges.tier.3.p': 'Credit bezichtigingsreis tot €3.500 + Return Stay-credit tot €1.250.',
      'page.viewing_privileges.tier.4.title': '€1,000,000+',
      'page.viewing_privileges.tier.4.p': 'Credit bezichtigingsreis tot €5.000 + Return Stay-credit tot €1.500.',
      'page.viewing_privileges.section.newbuilds.note': 'Bezichtigingsreis-credit is op basis van bonnen en uitbetaald bij overdracht (niet bij reservering). Return Stay-credit wordt bij overdracht uitgegeven als reistegoed/voucher (geen cash alternatief; 12 maanden geldig). Eén koperspartij per aankoop.',
      'page.viewing_privileges.section.resales.title': 'Bestaande bouw-voordelen',
      'page.viewing_privileges.section.resales.p': 'Voor bestaande bouw draaien we een maandelijkse VIP-credit in maart en april. Dit creëert urgentie zonder een prijzenslag.',
      'page.viewing_privileges.resale.vip.title': 'Maandelijkse VIP-credit bezichtigingsreis',
      'page.viewing_privileges.resale.vip.p': 'In maart 2026 en april 2026 ontvangt de eerste koper van bestaande bouw die een bindende private koopovereenkomst tekent een credit voor de bezichtigingsreis tot €1.500, uitbetaald bij overdracht.',
      'page.viewing_privileges.resale.concierge.title': 'Completion Concierge Pack',
      'page.viewing_privileges.resale.concierge.p': 'Alle kopers van bestaande bouw die binnen de campagneperiode tekenen ontvangen gestructureerde completion-ondersteuning: planning, notariscoördinatie en overdrachtsvoorbereiding.',
      'page.viewing_privileges.section.resales.note': 'VIP-selectie gebeurt op basis van het tijdstip van ondertekening dat Spanish Coast Properties registreert. Als de VIP-koper annuleert of niet in aanmerking komt, wordt de volgende in aanmerking komende koper in die maand geselecteerd.',
      'page.viewing_privileges.section.how.title': 'Hoe werkt het',
      'page.viewing_privileges.how.1.title': '1) Boek een gestructureerde bezichtigingsreis',
      'page.viewing_privileges.how.1.p': 'We bevestigen budget en wensen, maken een shortlist en plannen een strak schema voor de reis.',
      'page.viewing_privileges.how.2.title': '2) Reserveer binnen de campagneperiode',
      'page.viewing_privileges.how.2.p': 'Om te kwalificeren moet je tussen 1 maart en 30 april 2026 een bindende reservering/koopovereenkomst tekenen.',
      'page.viewing_privileges.how.3.title': '3) Rond af en ontvang credits',
      'page.viewing_privileges.how.3.p': 'Bij overdracht verwerken we je credits (tot de maxima) op basis van bonnen.',
      'page.viewing_privileges.section.terms.title': 'Belangrijkste voorwaarden (kort)',
      'page.viewing_privileges.terms.1': 'Credits worden alleen uitbetaald bij overdracht (niet bij reservering).',
      'page.viewing_privileges.terms.2': 'Bezichtigingsreis-credit is op basis van bonnen: vluchten, verblijf, huurauto en transfers. Maaltijden, upgrades en niet-bezichtigingsuitjes zijn uitgesloten.',
      'page.viewing_privileges.terms.3': 'Return Stay-credit wordt bij overdracht uitgegeven als reistegoed/voucher (geen cash alternatief; 12 maanden geldig), voor een tweede bezoek hier of elders. Eén koperspartij per aankoop. Nieuwbouw: maxima per tier. Bestaande bouw: maandelijkse VIP-max.',
      'page.viewing_privileges.terms.4': 'Campagneperiode: 1 maart t/m 30 april 2026 (CET/CEST). Overdracht kan later plaatsvinden.',
      'page.viewing_privileges.terms.5': 'Beperkte beschikbaarheid en mogelijk eerder einde bij het bereiken van capaciteit. Voorwaarden van toepassing.',
      'page.viewing_privileges.cta.read_full_terms': 'Lees alle voorwaarden',
      'page.viewing_privileges.cta.viewing_trip_package': 'Bezichtigingsreis-pakket',
      'page.viewing_privileges.footer.p': 'Private Client-bezichtigingsreizen die oriënteren omzetten in een zekere aankoopbeslissing.',

      'page.viewing_privileges_terms.hero.title': 'Signature Viewing Privileges Voorwaarden',
      'page.viewing_privileges_terms.hero.p': 'Deze voorwaarden zijn van toepassing op de Signature Viewing Privileges-campagne van Spanish Coast Properties. Credits worden alleen uitbetaald bij overdracht.',
      'page.viewing_privileges_terms.tag.window': 'Campagneperiode: 1 mrt – 30 apr 2026',
      'page.viewing_privileges_terms.tag.region': 'CET/CEST',
      'page.viewing_privileges_terms.tag.paid': 'Uitbetaald bij overdracht',
      'page.viewing_privileges_terms.hero.note': 'Als vertalingen voor het gemak worden getoond, is de Engelse versie de referentie bij verschil.',
      'page.viewing_privileges_terms.cta.back': 'Terug naar de actie',
      'page.viewing_privileges_terms.cta.email': 'Vraag via e-mail',
      'page.viewing_privileges_terms.cta.book': 'Aanvragen via e-mail',
      'page.viewing_privileges_terms.section.definitions.title': '1) Definities',
      'page.viewing_privileges_terms.def.1': '<strong>Koperspartij</strong>: één huishouden / groep die samen koopt.',
      'page.viewing_privileges_terms.def.2': '<strong>Campagneperiode</strong>: van 1 maart 2026 t/m 30 april 2026 (CET/CEST), inclusief.',
      'page.viewing_privileges_terms.def.3': '<strong>Bindende overeenkomst</strong>: een ondertekende reservering/private koopovereenkomst die bindend is volgens de afgesproken voorwaarden, inclusief vereiste aanbetalingen.',
      'page.viewing_privileges_terms.def.4': '<strong>Overdracht</strong>: notariële overdracht (escritura) van de aankoop die in aanmerking komt.',
      'page.viewing_privileges_terms.def.5': '<strong>Credits</strong>: completion-credits uitbetaald bij overdracht (niet bij reservering), onder voorbehoud van maxima en bonnen.',
      'page.viewing_privileges_terms.section.eligibility.title': '2) Geschiktheid',
      'page.viewing_privileges_terms.elig.1': 'Om te kwalificeren moet de koperspartij binnen de campagneperiode een bindende overeenkomst tekenen voor een woning die in aanmerking komt.',
      'page.viewing_privileges_terms.elig.2': 'Credits worden alleen uitbetaald bij notariële overdracht. Als de aankoop niet wordt afgerond, worden er geen credits uitgekeerd.',
      'page.viewing_privileges_terms.elig.3': 'Bezichtigingen moeten door Spanish Coast Properties zijn geregeld of bevestigd om kosten in aanmerking te laten komen.',
      'page.viewing_privileges_terms.elig.4': 'Eén set credits per koperspartij per aankoop. Credits zijn niet overdraagbaar.',
      'page.viewing_privileges_terms.section.newbuilds.title': '3) Nieuwbouw-credits (tiers)',
      'page.viewing_privileges_terms.section.newbuilds.p': 'Nieuwbouwkopers kunnen twee credits ontvangen: bezichtigingsreis-credit en Return Stay-credit. Maxima zijn afhankelijk van de koopsom.',
      'page.viewing_privileges_terms.section.newbuilds.note': 'Bezichtigingsreis-credit wordt bij overdracht vergoed op basis van bonnen (tot maxima). Return Stay-credit wordt bij overdracht uitgegeven als reistegoed/voucher (geen cash alternatief), 12 maanden geldig.',
      'page.viewing_privileges_terms.tier.1.title': '€250k – €399k',
      'page.viewing_privileges_terms.tier.1.p': 'Credit bezichtigingsreis tot €1.500 + Return Stay-credit tot €750.',
      'page.viewing_privileges_terms.tier.2.title': '€400k – €699k',
      'page.viewing_privileges_terms.tier.2.p': 'Credit bezichtigingsreis tot €2.500 + Return Stay-credit tot €1.000.',
      'page.viewing_privileges_terms.tier.3.title': '€700k – €999k',
      'page.viewing_privileges_terms.tier.3.p': 'Credit bezichtigingsreis tot €3.500 + Return Stay-credit tot €1.250.',
      'page.viewing_privileges_terms.tier.4.title': '€1,000,000+',
      'page.viewing_privileges_terms.tier.4.p': 'Credit bezichtigingsreis tot €5.000 + Return Stay-credit tot €1.500.',
      'page.viewing_privileges_terms.section.resales.title': '4) Credits bestaande bouw (maandelijkse VIP)',
      'page.viewing_privileges_terms.resale.1': 'In maart 2026 en april 2026 ontvangt de eerste koper van bestaande bouw die een bindende private koopovereenkomst tekent (tijdstip geregistreerd door Spanish Coast Properties) een bezichtigingsreis-credit tot €1.500, uitbetaald bij overdracht.',
      'page.viewing_privileges_terms.resale.2': 'Als de VIP-koper annuleert, niet in aanmerking komt of niet afrondt, wordt de volgende in aanmerking komende koper in die maand geselecteerd.',
      'page.viewing_privileges_terms.resale.3': 'Alle kopers van bestaande bouw die binnen de campagneperiode tekenen ontvangen het Completion Concierge Pack (niet-monetair).',
      'page.viewing_privileges_terms.section.expenses.title': '5) Kosten die in aanmerking komen (bezichtigingsreis-credit)',
      'page.viewing_privileges_terms.section.expenses.p': 'Bezichtigingsreis-credit is op basis van bonnen en beperkt tot gedocumenteerde kosten die in aanmerking komen, tot aan de relevante maxima.',
      'page.viewing_privileges_terms.exp.1': '<strong>Inbegrepen</strong>: vlucht/trein, verblijf, huurauto, luchthaventransfers en lokaal vervoer dat direct bij de bezichtigingsreis hoort.',
      'page.viewing_privileges_terms.exp.2': '<strong>Uitgesloten</strong>: maaltijden, upgrades, shoppen, entertainment, niet-bezichtigingsuitjes en kosten zonder bonnen.',
      'page.viewing_privileges_terms.exp.3': 'Bonnen moeten op naam van de koper staan (of duidelijk toerekenbaar aan de koperspartij) en op verzoek worden aangeleverd.',
      'page.viewing_privileges_terms.section.payment.title': '6) Uitbetaling & verwerking',
      'page.viewing_privileges_terms.pay.1': 'Credits worden alleen uitbetaald bij overdracht. Verwerking is doorgaans binnen 10 werkdagen na overdracht en verificatie van bonnen.',
      'page.viewing_privileges_terms.pay.2': 'Uitbetaling kan via bankoverschrijving en/of als credit op een factuur van Spanish Coast Properties, naar ons oordeel.',
      'page.viewing_privileges_terms.pay.3': 'Bonnen in een andere valuta kunnen worden omgerekend naar EUR met een redelijke referentiekoers.',
      'page.viewing_privileges_terms.section.general.title': '7) Algemeen',
      'page.viewing_privileges_terms.gen.1': 'Deze aanbieding kan niet worden ingewisseld voor contant geld boven de waarde van gedocumenteerde, in aanmerking komende kosten en de maxima.',
      'page.viewing_privileges_terms.gen.2': 'De aanbieding kan worden ingetrokken of vroegtijdig worden beëindigd bij het bereiken van capaciteit of bij vermoeden van misbruik/fraude.',
      'page.viewing_privileges_terms.gen.3': 'Spanish Coast Properties kan uitbetaling weigeren wanneer niet aan de voorwaarden is voldaan.',
      'page.viewing_privileges_terms.footer.p': 'Signature Viewing Privileges zijn bedoeld om de due diligence van serieuze kopers te ondersteunen.'
    },
    fr: {
      'lang.label': 'Langue',
      'lang.en': 'Anglais',
      ...
      'affiliate.links.viewing_privileges': 'Viewing Privileges (campagne)',
      'affiliate.links.viewing_privileges_note': 'Astuce : les affiliés peuvent ajouter la langue de l’acheteur, par ex. <span class=\"muted\" style=\"font-weight:900;\">?lang=de</span>, <span class=\"muted\" style=\"font-weight:900;\">?lang=nl</span> ou <span class=\"muted\" style=\"font-weight:900;\">?lang=fr</span>.',

      'home.hero.viewing_privileges': 'Signature Viewing Privileges',
      'home.footer.viewing_privileges': 'Viewing Privileges (mars–avril)',

      'page.viewing_trip.privileges.title': 'Signature Viewing Privileges (1 mars – 30 avril 2026)',
      'page.viewing_trip.privileges.p': 'Réservez un bien éligible pendant la période de campagne et recevez, à l’acte, un crédit pour votre voyage de visites. Pour le neuf, un crédit « Return Stay » supplémentaire est inclus. Conditions applicables.',
      'page.viewing_trip.privileges.cta': 'Voir l’offre',
      'page.viewing_trip.privileges.terms': 'Conditions',

      'page.viewing_privileges.hero.title': 'Signature Viewing Privileges',
      'page.viewing_privileges.hero.p': 'Une offre Private Client limitée, réservée aux acheteurs sérieux. Réservez un bien éligible pendant la période de campagne et recevez, à l’acte, des completion credits pour votre voyage de visites. Pour le neuf, un crédit « Return Stay » supplémentaire est inclus.',
      'page.viewing_privileges.tag.window': '1 mars – 30 avril 2026',
      'page.viewing_privileges.tag.completion': 'Payé à l’acte',
      'page.viewing_privileges.tag.caps': 'Plafonds sur justificatifs',
      'page.viewing_privileges.tag.newbuilds_resales': 'Neuf + ancien',
      'page.viewing_privileges.cta.book_email': 'Réserver par e-mail',
      'page.viewing_privileges.cta.browse_new_builds': 'Voir le neuf',
      'page.viewing_privileges.cta.browse_resales': 'Voir l’ancien',
      'page.viewing_privileges.cta.terms': 'Conditions',
      'page.viewing_privileges.hero.note': 'L’éligibilité repose sur une réservation/contrat privé d’achat contraignant signé pendant la période de campagne. Les crédits sont payés à l’acte. Disponibilité limitée. Conditions applicables.',
      'page.viewing_privileges.section.newbuilds.title': 'Avantages Neuf',
      'page.viewing_privileges.section.newbuilds.p': 'Les acheteurs de neuf reçoivent deux crédits à l’acte : un crédit « Viewing Trip » et un crédit « Return Stay ». Les plafonds sont liés au prix d’achat pour rester proportionnels. Le crédit Return Stay peut être utilisé pour un second séjour ici, ou comme crédit voyage ailleurs.',
      'page.viewing_privileges.tier.1.title': '€250k – €399k',
      'page.viewing_privileges.tier.1.p': 'Crédit voyage de visites jusqu’à €1.500 + crédit Return Stay jusqu’à €750.',
      'page.viewing_privileges.tier.2.title': '€400k – €699k',
      'page.viewing_privileges.tier.2.p': 'Crédit voyage de visites jusqu’à €2.500 + crédit Return Stay jusqu’à €1.000.',
      'page.viewing_privileges.tier.3.title': '€700k – €999k',
      'page.viewing_privileges.tier.3.p': 'Crédit voyage de visites jusqu’à €3.500 + crédit Return Stay jusqu’à €1.250.',
      'page.viewing_privileges.tier.4.title': '€1,000,000+',
      'page.viewing_privileges.tier.4.p': 'Crédit voyage de visites jusqu’à €5.000 + crédit Return Stay jusqu’à €1.500.',
      'page.viewing_privileges.section.newbuilds.note': 'Le crédit voyage de visites est sur justificatifs et payé à l’acte (pas à la réservation). Le crédit Return Stay est émis à l’acte sous forme de crédit voyage/voucher (pas d’alternative cash ; valable 12 mois). Un seul bénéfice par foyer/groupe acheteur.',
      'page.viewing_privileges.section.resales.title': 'Avantages Ancien',
      'page.viewing_privileges.section.resales.p': 'Pour l’ancien, nous proposons un crédit VIP mensuel en mars et en avril. Objectif : créer de l’urgence sans entrer dans une logique de remise.',
      'page.viewing_privileges.resale.vip.title': 'Crédit VIP mensuel (voyage de visites)',
      'page.viewing_privileges.resale.vip.p': 'En mars 2026 et avril 2026, le premier acheteur d’ancien à signer un contrat privé d’achat contraignant reçoit un crédit voyage de visites jusqu’à €1.500, payé à l’acte.',
      'page.viewing_privileges.resale.concierge.title': 'Completion Concierge Pack',
      'page.viewing_privileges.resale.concierge.p': 'Tous les acheteurs d’ancien signant pendant la période de campagne reçoivent un accompagnement structuré jusqu’à l’acte : calendrier, coordination notaire et préparation de la remise des clés.',
      'page.viewing_privileges.section.resales.note': 'La sélection VIP se fait selon l’horodatage de signature enregistré par Spanish Coast Properties. Si l’acheteur VIP annule ou devient inéligible, le prochain acheteur éligible du mois est sélectionné.',
      'page.viewing_privileges.section.how.title': 'Comment ça marche',
      'page.viewing_privileges.how.1.title': '1) Réserver un voyage de visites structuré',
      'page.viewing_privileges.how.1.p': 'Nous confirmons votre budget et vos critères, puis construisons une shortlist et un itinéraire efficace.',
      'page.viewing_privileges.how.2.title': '2) Réserver pendant la période de campagne',
      'page.viewing_privileges.how.2.p': 'Pour être éligible, vous devez signer une réservation/contrat privé contraignant entre le 1er mars et le 30 avril 2026.',
      'page.viewing_privileges.how.3.title': '3) Finaliser et recevoir les crédits',
      'page.viewing_privileges.how.3.p': 'À l’acte, nous traitons vos crédits éligibles (dans la limite des plafonds) sur justificatifs.',
      'page.viewing_privileges.section.terms.title': 'Conditions clés (version courte)',
      'page.viewing_privileges.terms.1': 'Crédits payés à l’acte uniquement (pas à la réservation).',
      'page.viewing_privileges.terms.2': 'Le crédit voyage de visites est sur justificatifs : vols, hébergement, location de voiture et transferts. Repas, upgrades et excursions non liées aux visites exclus.',
      'page.viewing_privileges.terms.3': 'Le crédit Return Stay est émis à l’acte sous forme de crédit voyage/voucher (pas d’alternative cash ; valable 12 mois), pour un second séjour ici ou ailleurs. Un seul foyer/groupe acheteur par achat. Neuf : plafonds par palier. Ancien : plafond VIP mensuel.',
      'page.viewing_privileges.terms.4': 'Période : 1 mars au 30 avril 2026 (CET/CEST). La finalisation peut intervenir après la période.',
      'page.viewing_privileges.terms.5': 'Disponibilité limitée et fin anticipée possible si la capacité est atteinte. Conditions applicables.',
      'page.viewing_privileges.cta.read_full_terms': 'Lire les conditions complètes',
      'page.viewing_privileges.cta.viewing_trip_package': 'Pack voyage de visites',
      'page.viewing_privileges.footer.p': 'Des voyages Private Client qui transforment la recherche en décision d’achat confiante.',

      'page.viewing_privileges_terms.hero.title': 'Conditions Signature Viewing Privileges',
      'page.viewing_privileges_terms.hero.p': 'Ces conditions s’appliquent à la campagne Signature Viewing Privileges de Spanish Coast Properties. Les crédits sont payés à l’acte uniquement.',
      'page.viewing_privileges_terms.tag.window': 'Période : 1 mars – 30 avril 2026',
      'page.viewing_privileges_terms.tag.region': 'CET/CEST',
      'page.viewing_privileges_terms.tag.paid': 'Payé à l’acte',
      'page.viewing_privileges_terms.hero.note': 'Si des traductions sont affichées pour convenance, la version anglaise fait référence en cas de différence.',
      'page.viewing_privileges_terms.cta.back': 'Retour à l’offre',
      'page.viewing_privileges_terms.cta.email': 'Question par e-mail',
      'page.viewing_privileges_terms.cta.book': 'Réserver par e-mail',
      'page.viewing_privileges_terms.section.definitions.title': '1) Définitions',
      'page.viewing_privileges_terms.def.1': '<strong>Foyer/groupe acheteur</strong> : un foyer / groupe achetant le bien ensemble.',
      'page.viewing_privileges_terms.def.2': '<strong>Période de campagne</strong> : du 1 mars 2026 au 30 avril 2026 (CET/CEST), inclus.',
      'page.viewing_privileges_terms.def.3': '<strong>Contrat contraignant</strong> : une réservation / un contrat privé d’achat signé, contraignant selon les conditions convenues, avec dépôts requis payés.',
      'page.viewing_privileges_terms.def.4': '<strong>Acte</strong> : finalisation chez le notaire (escritura) de l’achat éligible.',
      'page.viewing_privileges_terms.def.5': '<strong>Crédits</strong> : completion credits payés à l’acte (pas à la réservation), sous réserve de plafonds et justificatifs.',
      'page.viewing_privileges_terms.section.eligibility.title': '2) Éligibilité',
      'page.viewing_privileges_terms.elig.1': 'Pour être éligible, le foyer/groupe acheteur doit signer un contrat contraignant pour un bien éligible pendant la période de campagne.',
      'page.viewing_privileges_terms.elig.2': 'Les crédits sont payés uniquement si l’achat est finalisé chez le notaire. Si l’achat n’est pas finalisé, aucun crédit n’est dû.',
      'page.viewing_privileges_terms.elig.3': 'Les visites doivent être organisées ou confirmées via Spanish Coast Properties pour que les dépenses soient éligibles.',
      'page.viewing_privileges_terms.elig.4': 'Un seul ensemble de crédits par foyer/groupe acheteur et par achat. Non transférable.',
      'page.viewing_privileges_terms.section.newbuilds.title': '3) Crédits Neuf (plafonds par palier)',
      'page.viewing_privileges_terms.section.newbuilds.p': 'Les acheteurs de neuf peuvent recevoir deux crédits : Viewing Trip Credit et Return Stay Credit. Les plafonds dépendent du prix d’achat.',
      'page.viewing_privileges_terms.section.newbuilds.note': 'Le crédit voyage de visites est remboursé à l’acte sur justificatifs (dans la limite des plafonds). Le crédit Return Stay est émis à l’acte sous forme de crédit voyage/voucher (pas d’alternative cash), valable 12 mois.',
      'page.viewing_privileges_terms.tier.1.title': '€250k – €399k',
      'page.viewing_privileges_terms.tier.1.p': 'Crédit voyage de visites jusqu’à €1.500 + crédit Return Stay jusqu’à €750.',
      'page.viewing_privileges_terms.tier.2.title': '€400k – €699k',
      'page.viewing_privileges_terms.tier.2.p': 'Crédit voyage de visites jusqu’à €2.500 + crédit Return Stay jusqu’à €1.000.',
      'page.viewing_privileges_terms.tier.3.title': '€700k – €999k',
      'page.viewing_privileges_terms.tier.3.p': 'Crédit voyage de visites jusqu’à €3.500 + crédit Return Stay jusqu’à €1.250.',
      'page.viewing_privileges_terms.tier.4.title': '€1,000,000+',
      'page.viewing_privileges_terms.tier.4.p': 'Crédit voyage de visites jusqu’à €5.000 + crédit Return Stay jusqu’à €1.500.',
      'page.viewing_privileges_terms.section.resales.title': '4) Crédits Ancien (VIP mensuel)',
      'page.viewing_privileges_terms.resale.1': 'En mars 2026 et avril 2026, le premier acheteur d’ancien à signer un contrat privé d’achat contraignant (horodatage enregistré par Spanish Coast Properties) reçoit un crédit voyage de visites jusqu’à €1.500, payé à l’acte.',
      'page.viewing_privileges_terms.resale.2': 'Si l’acheteur VIP annule, devient inéligible ou ne finalise pas, le prochain acheteur éligible du mois est sélectionné.',
      'page.viewing_privileges_terms.resale.3': 'Tous les acheteurs d’ancien signant pendant la période de campagne reçoivent le Completion Concierge Pack (accompagnement non monétaire).',
      'page.viewing_privileges_terms.section.expenses.title': '5) Dépenses éligibles (crédit voyage de visites)',
      'page.viewing_privileges_terms.section.expenses.p': 'Le crédit voyage de visites est sur justificatifs et limité aux dépenses éligibles documentées, dans la limite des plafonds applicables.',
      'page.viewing_privileges_terms.exp.1': '<strong>Inclus</strong> : vols/train, hébergement, location de voiture, transferts aéroport et transports locaux directement liés au voyage de visites.',
      'page.viewing_privileges_terms.exp.2': '<strong>Exclus</strong> : repas, upgrades, achats, divertissements, excursions non liées aux visites et dépenses sans justificatifs.',
      'page.viewing_privileges_terms.exp.3': 'Les justificatifs doivent être au nom de l’acheteur (ou clairement attribuables au foyer/groupe acheteur) et fournis sur demande.',
      'page.viewing_privileges_terms.section.payment.title': '6) Paiement & traitement',
      'page.viewing_privileges_terms.pay.1': 'Les crédits sont payés à l’acte uniquement. Le traitement est généralement sous 10 jours ouvrés après l’acte et vérification des justificatifs.',
      'page.viewing_privileges_terms.pay.2': 'Le paiement peut être effectué par virement bancaire et/ou sous forme d’avoir sur une facture Spanish Coast Properties, à notre discrétion.',
      'page.viewing_privileges_terms.pay.3': 'Les justificatifs en devise non EUR peuvent être convertis en EUR selon un taux de référence raisonnable.',
      'page.viewing_privileges_terms.section.general.title': '7) Général',
      'page.viewing_privileges_terms.gen.1': 'Cette offre ne peut pas être échangée contre de l’argent au-delà de la valeur des dépenses éligibles documentées et des plafonds applicables.',
      'page.viewing_privileges_terms.gen.2': 'L’offre peut être retirée ou arrêtée de manière anticipée si la capacité est atteinte ou en cas de suspicion d’abus/fraude.',
      'page.viewing_privileges_terms.gen.3': 'Spanish Coast Properties peut refuser le paiement des crédits lorsque les conditions d’éligibilité ne sont pas respectées.',
      'page.viewing_privileges_terms.footer.p': 'Signature Viewing Privileges ont pour but de soutenir la due diligence des acheteurs sérieux.'
    }
  };
  ...
  const AUTO_TRANSLATION_GLOSSARY = {
    ...
    de: {
      'Spanish Coast Properties': 'Spanish Coast Properties',
      'Costa Blanca South': 'Costa Blanca Süd',
      'Traspaso': 'Traspaso',
      'WhatsApp': 'WhatsApp',
      'TikTok': 'TikTok',
      'Instagram': 'Instagram'
    ...
    nl: {
      'Spanish Coast Properties': 'Spanish Coast Properties',
      'Costa Blanca South': 'Costa Blanca Zuid',
      'Traspaso': 'Traspaso',
      'WhatsApp': 'WhatsApp',
      'TikTok': 'TikTok',
      'Instagram': 'Instagram'
    ...
    no: {
      'Spanish Coast Properties': 'Spanish Coast Properties',
      'Costa Blanca South': 'Costa Blanca Sør',
      'Traspaso': 'Traspaso',
      'WhatsApp': 'WhatsApp',
      'TikTok': 'TikTok',
      'Instagram': 'Instagram'
  ...
  const STATIC_PHRASE_OVERRIDES = {
    ...
    no: {
      ...
      'Trends': 'Trender',
      'Services': 'Tjenester',
      'Street Scout Inbox': 'Street Scout-innboks',
      'Updated daily': 'Oppdatert daglig',
      'My language': 'Mitt språk',
      'Work With Us': 'Jobb med oss',
      'Sign in / Create account': 'Logg inn / Opprett konto',
      'How It Works': 'Slik fungerer det',
      'Open Street Scout': 'Åpne Street Scout',
      'Email us': 'Send e-post',
      'See services': 'Se tjenester',
      'Open in shop': 'Åpne i butikk',
      'Details': 'Detaljer',
      'Install support': 'Installasjonsstøtte',
      'Secure handover': 'Sikker overlevering',
      'No description available.': 'Ingen beskrivelse tilgjengelig.',
      'Why this matters': 'Hvorfor dette er viktig',
      'Request install': 'Be om installasjon',
      'How we work': 'Slik jobber vi',
      'Map View': 'Kartvisning',
      'Listing Details': 'Annonsedetaljer',
      'Apartamento': 'Leilighet',
      'Piso': 'Leilighet',
      'Ático': 'Toppetasje',
      'Atico': 'Toppetasje',
      'Chalet': 'Villa',
      'Casa adosada': 'Rekkehus',
      'Adosado': 'Rekkehus',
      'Obra nueva': 'Nybygg',
      'En venta': 'Til salgs',
      'En alquiler': 'Til leie',
      'Piscina': 'Basseng',
      'Garaje': 'Garasje',
      'Terraza': 'Terrasse',
      'Ascensor': 'Heis',
      'Aire acondicionado': 'Klimaanlegg'
    },
    da: {
      'Any': 'Alle',
      'All': 'Alle',
      ...
      'Trends': 'Tendenser',
      'Services': 'Tjenester',
      'Street Scout Inbox': 'Street Scout-indbakke',
      'Updated daily': 'Opdateret dagligt',
      'My language': 'Mit sprog',
      'Work With Us': 'Arbejd med os',
      'Sign in / Create account': 'Log ind / Opret konto',
      'How It Works': 'Sådan fungerer det',
      'Open Street Scout': 'Åbn Street Scout',
      'Email us': 'Send e-mail',
      'See services': 'Se tjenester',
      'Open in shop': 'Åbn i butik',
      'Details': 'Detaljer',
      'Install support': 'Installationsstøtte',
      'Secure handover': 'Sikker overdragelse',
      'No description available.': 'Ingen beskrivelse tilgængelig.',
      'Why this matters': 'Hvorfor dette er vigtigt',
      'Request install': 'Anmod om installation',
      'How we work': 'Sådan arbejder vi',
      'Map View': 'Kortvisning',
      'Listing Details': 'Annoncedetaljer',
      'Apartamento': 'Lejlighed',
      'Piso': 'Lejlighed',
      'Ático': 'Penthouse',
      'Atico': 'Penthouse',
      'Chalet': 'Villa',
      'Casa adosada': 'Rækkehus',
      'Adosado': 'Rækkehus',
      'Obra nueva': 'Nybyggeri',
      'En venta': 'Til salg',
      'En alquiler': 'Til leje',
      'Piscina': 'Pool',
      'Garaje': 'Garage',
      'Terraza': 'Terrasse',
      'Ascensor': 'Elevator',
  ...
  const collectDynamicTextNodes = (root, scopeSelector, targetCode) => {
    ...
    // Only translate plain text nodes inside explicit dynamic scopes. This prevents re-translating already-localized
    // UI labels (e.g. "Red" meaning "Network") into unrelated meanings (e.g. "Rojo").
    if (scopeSelector && !scopeRoots.length) return [];

    // Explicitly requested full-page translation (no scope selector).
  ...
  const translateDynamicDom = async (
    ...
    const nodes = [
      ...
      ...collectDynamicTextNodes(root, scopeSelector, targetCode)
    ];
