...
const CACHE_NAME = 'scp-cache-20260210m';
...
const PRECACHE_PATHS = [
  ...
  './services.html',
  './agents.html',
  './style.css?v=20260210m',
  './site.js?v=20260210m',
  './catalog.js?v=20260210m',
  './catalog-page.js?v=20260210m',
  './app.js?v=20260210m',
  './custom-listings.js?v=20260210m',
  './inmovilla-listings.js?v=20260210m',
  './brochure.js?v=20260210m',
  './config.js?v=20260210m',
  './supabase-init.js?v=20260210m',
  './account.js?v=20260210m',
  './admin-favourites.js?v=20260210m',
  './admin-crm.js?v=20260210m',
  './data.js?v=20260210m',
  './businesses-data.js?v=20260210m',
  './manifest.webmanifest?v=20260210m',
